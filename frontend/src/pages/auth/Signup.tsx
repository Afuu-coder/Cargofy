    ...
    return (
      <div className="min-h-screen bg-[#080C16] flex items-center justify-center p-6">
        <div className="w-full max-w-sm text-center">
          ...
          <Link
            to="/login"
            className="inline-flex items-center gap-2 px-8 py-3 rounded-xl text-[13px] font-bold transition-all hover:opacity-90"
            style={{
        ...
        <div className="relative z-10">
          ...
          <div className="mb-14">
            ...
            <p className="text-slate-400 text-[15px] leading-relaxed max-w-[300px]">
              Set up your command center in under 2 minutes. Monitor every
              shipment. Prevent every spoilage.
            </p>
          </div>
