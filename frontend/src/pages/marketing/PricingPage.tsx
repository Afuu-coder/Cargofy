...
const FAQS = [
  {
    ...
    a: "Yes — 14-day full access, no credit card required.",
  },
  {
    q: "Can I upgrade mid-month?",
    a: "Yes. Charges are prorated based on the days remaining in your billing cycle.",
  },
  {
    q: "Do you charge per shipment or per user?",
    a: "Starter and Growth are shipment-based. Enterprise is fully custom.",
  },
  {
    q: "What IoT sensors does Cargofy support?",
    a: "Teltonika, Trakker, Monnit, and any MQTT-compatible sensor. We also offer our own certified sensor kit (optional).",
  },
  {
    q: "Is WhatsApp integration included?",
    a: "Push alerts are included in all plans. WhatsApp is included in Growth and above.",
  },
  {
    q: "Can we export compliance data for audits?",
    a: "The Growth plan exports PDF compliance reports. Enterprise gets PDF + Excel + API access.",
  },
  {
    q: "Is there a setup fee?",
    a: "No setup fees on Starter or Growth. Enterprise may include an implementation fee for custom enterprise workflows.",
  },
];
    ...
    >
      ...
      <section className="pt-32 pb-16 lg:pt-48 lg:pb-24 border-b border-[#1E293B] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            Simple, Transparent{" "}
            <span style={{ color: COLORS.teal }}>Pricing</span>.
          </h1>
          <p className="mt-4 text-lg md:text-xl text-[#94A3B8] mx-auto mb-4 leading-relaxed max-w-2xl">
            Built for Cold Chain Operations of Every Size.
            <br />
            ...
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead>
                <tr>
                  ...
                  <th className="p-8 border-l border-[#1E293B] w-1/4">
                    ...
                    <div className="text-4xl font-bold text-[#4DD9AC] mb-2">
                      ₹0
                    </div>
                  ...
                  <th className="p-8 border-l border-[#1E293B] w-1/4 bg-[#111622] relative overflow-hidden">
                    ...
                    >
                      GROWTH <Zap className="w-5 h-5 text-[#4DD9AC]" />
                    </div>
                    <div className="text-4xl font-bold text-white mb-2">
                      ₹12,999
                      <span className="text-lg text-[#94A3B8] font-normal">
                        /mo
                      </span>
                    </div>
              ...
              <tbody className="divide-y divide-[#1E293B]">
                {[
                  ...
                  { feature: "Live tracking", s: "✅", g: "✅", e: "✅" },
                  {
                    ...
                    g: (
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4 text-[#4DD9AC] shrink-0" />{" "}
                        AI-powered
                      </div>
                    ),
                    e: (
                  ...
                  <tr
                    key={idx}
                    className="hover:bg-[#111622]/50 transition-colors"
                  >
                    <td className="p-5 px-8 text-white font-medium">
                      {row.feature}
                    </td>
                    <td className="p-5 px-8 border-l border-[#1E293B] text-[#94A3B8]">
                      {row.s === "✅" ? (
                        <CheckCircle2 className="w-5 h-5 text-[#4DD9AC]" />
                      ) : row.s === "❌" ? (
                        <XCircle className="w-5 h-5 text-[#FF4D4D] opacity-50" />
                      ) : (
                        row.s
                      )}
                    </td>
                    <td
                      className={`p-5 px-8 border-l border-[#1E293B] bg-[#111622]/50 ${row.highlightGrowth ? "text-[#4DD9AC] font-bold" : "text-white"}`}
                    >
                      {row.g === "✅" ? (
                        <CheckCircle2 className="w-5 h-5 text-[#4DD9AC]" />
                      ) : row.g === "❌" ? (
                ...
                <tr>
                  ...
                  <td className="p-8 border-l border-t border-[#1E293B]">
                    <Link
                      to="/signup"
                      className="block w-full text-center border border-[#4DD9AC] text-[#4DD9AC] py-3 rounded hover:bg-[#4DD9AC]/10 font-bold transition-colors"
                    >
                      Start Free
                    </Link>
                  </td>
                  <td className="p-8 border-l border-t border-[#1E293B] bg-[#111622]">
                    <Link
                      to="/signup"
                      className="block w-full text-center bg-[#4DD9AC] text-[#080B12] py-3 rounded hover:opacity-90 font-bold transition-opacity"
                    >
                      Start Trial
                    </Link>
                  </td>
                  <td className="p-8 border-l border-t border-[#1E293B]">
                    <Link
                      to="/signup"
                      className="block w-full text-center border border-[#1E293B] bg-[#1E293B] text-white py-3 rounded hover:bg-[#2A3B52] font-bold transition-colors"
                    >
                      Contact Sales
                    </Link>
                  </td>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-[#94A3B8]">
              Available exclusively on Growth & Enterprise plans.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              {
                icon: <BarChart3 className="text-[#4DD9AC]" />,
                name: "Advanced Analytics Pack",
                price: "₹2,999/mo",
                desc: "Custom dashboards, raw data export, BI tool integration",
              },
              {
                icon: <Radio className="text-[#4DD9AC]" />,
                name: "IoT Hardware Pairing",
                price: "₹499/device/mo",
                desc: "Sensor provisioning + remote diagnostics + replacement SLA",
              },
              {
                icon: <Building2 className="text-[#4DD9AC]" />,
                name: "Cold Hub Network Access",
                price: "₹1,999/mo",
                desc: "Priority booking at 40+ partner cold hubs across India",
              },
              {
                icon: <Bell className="text-[#4DD9AC]" />,
                name: "WhatsApp Premium Alerts",
                price: "₹1,499/mo",
                desc: "Unlimited WhatsApp messages + read receipts + driver ack tracking",
              },
              {
                icon: <FileText className="text-[#4DD9AC]" />,
                name: "Compliance Suite",
                price: "₹3,999/mo",
                desc: "Automated compliance reports + e-signature + audit-ready export",
              },
              {
                icon: <Map className="text-[#4DD9AC]" />,
                name: "Route Intelligence",
                price: "₹2,499/mo",
                desc: "AI route optimization + traffic-aware ETA + alternate route auto-suggest",
              },
            ].map((addon, i) => (
              <div
                key={i}
                className="border border-[#1E293B] rounded-xl p-6 bg-[#080B12] hover:border-[#4DD9AC]/50 transition-colors"
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="text-3xl">{addon.icon}</div>
                  <div className="bg-[#111622] text-[#4DD9AC] px-3 py-1 rounded text-sm font-bold font-mono border border-[#1E293B]">
                    {addon.price}
                  </div>
                </div>
          ...
          <div className="border border-[#1E293B] rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row bg-[#0A0D14]">
            ...
            <div className="p-10 md:w-1/2 border-b md:border-b-0 md:border-r border-[#1E293B]">
              <div className="flex items-center gap-3 mb-8">
                ...
                >
                  Calculate Your Cargofy ROI
                </h2>
              </div>

              <div className="space-y-8">
                <div>
                  <label className="block text-[#94A3B8] mb-2 font-medium">
                    How many cold chain shipments per month?
                  </label>
                  <input
                    type="range"
                    min="50"
                ...
                <div>
                  <label className="block text-[#94A3B8] mb-2 font-medium">
                    Average value of goods per shipment? (₹)
                  </label>
                  <input
                    type="range"
                    min="10000"
                ...
                <div>
                  <label className="block text-[#94A3B8] mb-2 font-medium">
                    Your current spoilage/loss rate? (%)
                  </label>
                  <input
                    type="range"
                    min="0.5"
            ...
            <div className="p-10 md:w-1/2 bg-[#111622] flex flex-col justify-center">
              <h3 className="text-sm font-bold text-[#94A3B8] uppercase tracking-wider mb-8">
                Your Estimated Results With Cargofy
              </h3>
              ...
              <div className="space-y-4 mb-10">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-[#94A3B8]">
                    Expected loss after Cargofy:
                  </span>
                  <span className="text-[#4DD9AC] font-mono">
                    ₹{" "}
                    {expectedLoss.toLocaleString(undefined, {
                      maximumFractionDigits: 0,
                    })}
                  </span>
                </div>
                <div className="flex justify-between items-center pt-2 border-t border-[#1E293B]">
                  ...
                  <span className="text-[#4DD9AC] font-bold font-mono text-xl">
                    ₹{" "}
                ...
                <div className="flex justify-between items-center text-sm">
                  <span className="text-[#64748B]">
                    Cargofy cost (Growth plan):
                  </span>
                  <span className="text-[#64748B] font-mono">
                    - ₹ {growthCost.toLocaleString()}
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-[#0A0D14] p-4 rounded-lg border border-[#1E293B]">
                  <div className="text-[#94A3B8] text-xs uppercase mb-1">
                    Estimated ROI
                  </div>
                  <div className="text-3xl font-bold text-[#4DD9AC] font-mono">
              ...
              <Link
                to="/signup"
                className="w-full text-center bg-white text-[#080B12] py-4 rounded-lg font-bold hover:bg-[#4DD9AC] transition-colors shadow-lg"
              >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {FAQS.map((faq, idx) => (
              <div
                key={idx}
                className="bg-[#111622] border border-[#1E293B] rounded-xl p-6 hover:border-[#4DD9AC]/30 transition-colors"
              >
      ...
      <section className="py-32 border-t border-[#1E293B] bg-[#080B12]">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-[#94A3B8] mb-12 max-w-2xl mx-auto leading-relaxed">
            Talk to our team. We'll show you exactly how Cargofy maps to your
            cold chain operation — and what you'd save.
          </p>
          <div className="flex flex-col sm:flex-row justify-center gap-6">
            <Link
              to="/signup"
              className="bg-transparent border border-[#1E293B] text-white px-8 py-4 rounded-md font-bold text-lg hover:bg-[#111622] transition-colors"
            >
              Book a 20-min Call →
            </Link>
            <Link
