...
import { 
  Menu, X, ChevronDown, ArrowRight, Target, Globe, Users, Navigation, Activity, ShieldCheck, Newspaper
} from 'lucide-react';
...
const TEAM = [
  { name: 'Karan Mehta', role: 'CEO & Co-founder', bg: 'Background in supply chain consulting and Northeast India ops', initial: 'K' },
  { name: 'Aditi Rao', role: 'CTO & Co-founder', bg: 'Built IoT systems for cold storage networks across tier-2 India', initial: 'A' },
  { name: 'Sameer Singh', role: 'Head of Product', bg: 'Ex-Locus, 8 years in last-mile logistics product development', initial: 'S' }
];
  ...
  return (
    <div style={{ backgroundColor: COLORS.bg, color: COLORS.textMain, fontFamily: FONTS.body, minHeight: '100vh' }}>
      ...
      <section className="py-24 bg-[#0A0D14]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4 mb-8">
            ...
            <h2 className="text-sm font-bold text-[#4DD9AC] uppercase tracking-widest font-mono">The Problem We Couldn't Ignore</h2>
          </div>
          
          <div className="prose prose-lg prose-invert max-w-none space-y-6 text-[#94A3B8] leading-relaxed">
            <p>
              In 2023, our founders were working on supply chain tech for Northeast India — one of the country's most challenging logistics corridors. They kept hearing the exact same story from every distributor:
            </p>
            ...
            <p>
              Cold chain logistics in India had the same tracking tools as regular logistics — but different physics. A truck delay that costs you 30 minutes in Delhi costs you your entire dairy load on a 42°C day in Assam.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-[#111622] border border-[#1E293B] p-10 rounded-2xl relative overflow-hidden">
              ...
              <h2 className="text-sm font-bold text-[#4DD9AC] uppercase tracking-widest mb-6 font-mono relative z-10">Our Mission</h2>
              <p className="text-2xl text-white leading-relaxed relative z-10" style={{ fontFamily: FONTS.display }}>
                Prevent food loss and pharmaceutical waste in India's cold chain by giving every logistics operator real-time intelligence and the tools to act on it.
              </p>
            </div>
            
            <div className="bg-[#111622] border border-[#1E293B] p-10 rounded-2xl relative overflow-hidden">
              <Globe className="absolute top-10 right-10 w-32 h-32 text-[#1E293B] opacity-30 pointer-events-none" />
              <h2 className="text-sm font-bold text-[#4DD9AC] uppercase tracking-widest mb-6 font-mono relative z-10">Our Vision</h2>
              <p className="text-2xl text-white leading-relaxed relative z-10" style={{ fontFamily: FONTS.display }}>
                A world where no perishable product is lost to a preventable temperature excursion — because every cold chain operator has the visibility, prediction, and tools to stop it in time.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-[#080B12]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {TEAM.map((member, idx) => (
              <div key={idx} className="bg-[#0A0D14] border border-[#1E293B] rounded-xl p-8 hover:-translate-y-1 transition-transform">
                ...
                <div className="text-[#4DD9AC] font-mono text-xs uppercase tracking-widest mb-4">{member.role}</div>
          ...
          <div className="text-center">
            <Link to="/about" className="inline-flex items-center text-[#94A3B8] hover:text-white transition-colors">
      ...
      <section className="py-24 bg-[#111622] border-y border-[#1E293B]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-sm font-bold text-[#4DD9AC] uppercase tracking-widest font-mono mb-4">How We Build</h2>
            <h3 style={{ fontFamily: FONTS.display }} className="text-4xl font-bold text-white">Our Values</h3>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="flex gap-6">
              ...
              <div>
                <h4 className="text-xl font-bold text-white mb-3">Operational First</h4>
                <p className="text-[#94A3B8] leading-relaxed">We don't ship features. We ship tools that dispatchers actually use at 3 AM during a critical excursion.</p>
              </div>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <div>
                <h4 className="text-xl font-bold text-white mb-3">Specific Over Vague</h4>
                <p className="text-[#94A3B8] leading-relaxed">Our product speaks in shipment IDs, degrees Celsius, and minutes — not "AI insights" and "smart logistics."</p>
              </div>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <div>
                <h4 className="text-xl font-bold text-white mb-3">India-Native</h4>
                <p className="text-[#94A3B8] leading-relaxed">We build for Indian roads, Indian infrastructure, and Indian supply chains — NE corridors, hill routes, monsoon delays, and all.</p>
              </div>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <div>
                <h4 className="text-xl font-bold text-white mb-3">Loss = Waste</h4>
                <p className="text-[#94A3B8] leading-relaxed">Every prevented spoilage is food saved, CO₂ not emitted, and working capital protected. We measure both.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-[#0A0D14]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            {/* Press */}
            <div>
              <h2 className="text-sm font-bold text-[#94A3B8] uppercase tracking-widest mb-8 font-mono">In The News</h2>
              <div className="space-y-6 mb-8">
                ...
                <div className="border border-[#1E293B] rounded-lg p-6 bg-[#111622]">
                  ...
                  <p className="text-white italic">"India's most important cold chain operating system..."</p>
                </div>
              </div>
              <div className="flex gap-4">
                <Link to="/about" className="text-sm text-[#94A3B8] hover:text-white transition-colors underline">Press Kit</Link>
                <Link to="/about" className="text-sm text-[#94A3B8] hover:text-white transition-colors underline">Media Contact</Link>
              </div>
            </div>

            {/* Careers */}
            <div>
              <h2 className="text-sm font-bold text-[#94A3B8] uppercase tracking-widest mb-8 font-mono">Join Us</h2>
              <div className="bg-[#111622] border border-[#1E293B] rounded-xl p-8 h-[calc(100%-4rem)] flex flex-col">
                <p className="text-white text-lg mb-8 leading-relaxed">
                  We're a small team solving a big problem. If you care about logistics, food systems, and building software that actually runs in the real world — we want to hear from you.
                </p>
                <div className="space-y-4 mb-8 flex-1">
                  <div className="flex items-center justify-between text-[#94A3B8] border-b border-[#1E293B] pb-2">
                    ...
                    <span className="text-xs uppercase bg-[#1E293B] px-2 py-1 rounded">Tech</span>
                  </div>
                  <div className="flex items-center justify-between text-[#94A3B8] border-b border-[#1E293B] pb-2">
                    <span>ML Engineer (Vertex AI / Python)</span>
                    <span className="text-xs uppercase bg-[#1E293B] px-2 py-1 rounded">Data</span>
                  </div>
                  <div className="flex items-center justify-between text-[#94A3B8] border-b border-[#1E293B] pb-2">
                    <span>Logistics Solutions Engineer</span>
                    <span className="text-xs uppercase bg-[#1E293B] px-2 py-1 rounded">Sales</span>
                  </div>
                  <div className="flex items-center justify-between text-[#94A3B8] pb-2">
                    <span>Customer Success (Ops background)</span>
                    <span className="text-xs uppercase bg-[#1E293B] px-2 py-1 rounded">CS</span>
                  </div>
                </div>
                <Link to="/about" className="inline-flex items-center text-[#4DD9AC] hover:text-white font-bold transition-colors">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex justify-between items-center h-20">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <Link to="/about" className="text-white border-b-2 border-[#4DD9AC] pb-1 text-sm font-medium">About</Link>
        </div>
