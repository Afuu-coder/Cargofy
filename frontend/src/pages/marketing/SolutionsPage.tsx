...
const INDUSTRY_DATA: Record<string, any> = {
  dairy: {
    ...
    subtitle:
      "Milk, paneer, curd, butter — every dairy SKU has a tight temperature window and a short shelf life. Cargofy watches both.",
    ...
    impact:
      "₹2.8L avg monthly savings · 68% reduction in dairy loss · 91% FSSAI compliance rate",
    dashboards: [
      {
  ...
  seafood: {
    ...
    subtitle:
      "From harbour to plate, freshness is everything. Cargofy ensures perfect temperature and humidity for your catch.",
    ...
    impact:
      "Zero-rejection export rate · 45% reduction in spoiled catch · Fully traceable logistics",
    dashboards: [
      {
  ...
  pharma: {
    ...
    subtitle:
      "Vaccines, biologics, and active ingredients require absolute precision. Cargofy delivers GDP-compliant peace of mind.",
    ...
    impact:
      "100% GDP compliance · Zero regulatory fines · Complete chain of custody",
    dashboards: [
      {
    ...
    icon: Pill,
    displayTitle: ["Zero-Tolerance Cold Chain", "for Pharma."],
  },
  frozen: {
    title: "Deep Freeze Intelligence Built for Frozen Goods.",
    displayTitle: ["Deep Freeze Intelligence", "Built for Frozen Goods."],
    subtitle:
      "From blast-freeze to final delivery, Cargofy maintains the -18°C cold chain with zero tolerance for drift.",
    problemHeadline: "Frozen Cargo Has No Margin for Temperature Drift.",
    problemPoints: [
      "Safe band: -18°C or colder — any drift = quality loss",
      "Refreezing after partial thaw destroys product integrity",
      "Compressor failures are silent — GPS trackers don't detect them",
      "Destination receiving teams reject cargo based on appearance alone",
    ],
    solutions: [
      "Compressor health monitoring every 5 minutes",
      "Instant alert on any temp rise above -15°C",
      "Freeze-thaw cycle detection via temperature pattern analysis",
      "Delivery temperature certificate for receiver acceptance",
      "Cold storage partner network for emergency offloading",
    ],
    impact:
      "99.2% successful frozen delivery rate · Compressor fault detected 40 min early on avg",
    dashboards: [
      {
        name: "Control Tower — Frozen View",
        points: [
          "Deep freeze band pre-set: ≤-18°C",
          "Compressor health indicator per vehicle",
          "Any temp above -15°C triggers CRITICAL immediately",
        ],
      },
      {
        name: "Risk Engine — Frozen Calibration",
        points: [
          "Freeze-thaw pattern detection algorithm",
          "Door-open duration tracking (heat ingress risk)",
          "Ambient temp vs reefer capacity threshold model",
        ],
      },
      {
        name: "Alerts — Frozen SOP",
        points: [
          "Immediate compressor check alert to driver",
          "Nearest cold storage (≤-18°C capable) recommended",
          "Delivery rejection pre-warning sent to receiver",
        ],
      },
      {
        name: "Compliance — Frozen",
        points: [
          "Full temperature log from -18°C baseline",
          "Freeze-thaw cycle count per shipment",
          "Chain of custody for frozen exports",
        ],
      },
    ],
    icon: Snowflake,
  ...
  fv: {
    title: "Smart Cold Chain Built for Fresh Fruits & Vegetables.",
    displayTitle: ["Smart Cold Chain", "for Fresh F&V."],
    subtitle:
      "Every crop type has its own ideal storage band. Cargofy handles the complexity of multi-SKU, multi-temperature fresh produce logistics.",
    problemHeadline: "Fresh Produce Spoils Faster Than Any Other Category.",
    problemPoints: [
      "Every crop has a different safe band — tomato ≠ mango ≠ banana",
      "Ethylene gas from ripening fruit contaminates co-loaded SKUs",
      "Transit delays on NH routes cause ambient temp spikes",
      "No real-time humidity control leads to dehydration losses",
    ],
    solutions: [
      "Per-SKU temperature band configuration",
      "Multi-zone vehicle support for mixed cargo loads",
      "Humidity monitoring alongside temperature",
      "Predictive ETA modelling to flag high-risk delay routes",
      "APMC and retail hub compatibility reports",
    ],
    impact:
      "38% less produce waste · 2-day shelf life extension · 82% reduction in rejection at mandis",
    dashboards: [
      {
        name: "Control Tower — F&V View",
        points: [
          "Per-crop temp band displayed on each shipment card",
          "Mixed load compatibility flag (ethylene risk)",
          "Mandi arrival time countdown",
        ],
      },
      {
        name: "Risk Engine — F&V Calibration",
        points: [
          "Multi-SKU risk scoring (weighted by value)",
          "Humidity breach = independent HIGH alert",
          "Route delay → recalculated spoilage window",
        ],
      },
      {
        name: "Alerts — F&V SOP",
        points: [
          "Nearest cold store with correct crop temp capability",
          "APMC gate-open timing alert",
          "Ethylene contamination pre-warning for mixed loads",
        ],
      },
      {
        name: "Compliance — F&V",
        points: [
          "APMC and export quality documentation",
          "Field-to-fork temperature trail",
          "Per-batch rejection analysis",
        ],
      },
    ],
    icon: Carrot,
  ...
  fmcg: {
    title: "Cold Chain Intelligence Built for FMCG.",
    displayTitle: ["Cold Chain Intelligence", "Built for FMCG."],
    subtitle:
      "Multi-SKU, multi-route, high-velocity. Cargofy manages the complexity of FMCG cold chain at scale — from primary distribution to last-mile delivery.",
    problemHeadline:
      "FMCG Cold Chain Is Volume, Velocity, and Zero Room for Error.",
    problemPoints: [
      "Hundreds of SKUs, each with different temp requirements",
      "High-volume dispatch windows (4–7 AM) with minimal oversight",
      "Route complexity across urban, peri-urban, and rural segments",
      "Promotional season surges overwhelm manual monitoring",
    ],
    solutions: [
      "Batch-level temperature monitoring across all SKUs",
      "Automated morning dispatch health check before vehicle leaves depot",
      "Multi-vehicle fleet view for distribution managers",
      "AI prioritisation of at-risk shipments across large fleets",
      "Automated compliance exports for retailers and distributors",
    ],
    impact:
      "68% faster exception resolution · 4.1x ROI on monitoring spend · FSMS-compliant audit trail",
    dashboards: [
      {
        name: "Control Tower — FMCG View",
        points: [
          "Fleet-level status at a glance",
          "Pre-dispatch reefer health check integration",
          "SKU-wise compliance status",
        ],
      },
      {
        name: "Risk Engine — FMCG Calibration",
        points: [
          "Multi-SKU weighted risk model",
          "Surge mode for seasonal high-volume periods",
          "Auto-prioritise critical SKUs in exception queue",
        ],
      },
      {
        name: "Alerts — FMCG SOP",
        points: [
          "Batch-level alerts with SKU details",
          "Distributor notification on delivery risk",
          "Pre-dispatch vehicle rejection alert",
        ],
      },
      {
        name: "Compliance — FMCG",
        points: [
          "FSMS and FSSAI compliance exports",
          "Retailer-ready delivery confirmation",
          "Distribution center intake log",
        ],
      },
    ],
    icon: Factory,
...
export const SolutionsPage: React.FC = () => {
  ...
  return (
    ...
    >
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="relative group">
                <Link
                  to="/solutions"
                  className="text-white border-b-2 border-[#4DD9AC] pb-1 text-sm font-medium flex items-center"
                >
                ...
                <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-[#111622] border border-[#1E293B] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                  <div className="py-1">
                    <Link
                      to="/solutions/dairy"
                      className="block px-4 py-2 text-sm text-[#94A3B8] hover:bg-[#1A2133] hover:text-white"
                    >
                      Dairy
                    </Link>
                    <Link
                      to="/solutions/seafood"
                      className="block px-4 py-2 text-sm text-[#94A3B8] hover:bg-[#1A2133] hover:text-white"
                    >
                      Seafood
                    </Link>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <Link
                to={`/signup?industry=${industryKey}`}
      ...
      {/* HERO SECTION */}
      <section
        className="pt-32 pb-16 lg:pt-48 lg:pb-24 relative overflow-hidden"
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 50% 0%, #4DD9AC 1px, transparent 1px)",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-[#111622] border border-[#1E293B] text-[#4DD9AC] px-4 py-2 rounded-full font-mono text-sm mb-8">
            <data.icon className="w-4 h-4" /> CARGOFY FOR{" "}
          ...
          >
            {data.displayTitle ? data.displayTitle[0] : data.title}
            <br />
            <span style={{ color: COLORS.teal }}>
              {data.displayTitle ? data.displayTitle[1] : ""}
            </span>
          </h1>
          ...
          <div className="flex justify-center gap-4">
            ...
            >
              Book a{" "}
              {industryKey.charAt(0).toUpperCase() + industryKey.slice(1)} Demo
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-[#94A3B8]">
              The platform naturally adapts to the physics of your product.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {data.dashboards.map((dash: any, i: number) => (
              <div
                key={i}
                className="border border-[#1E293B] bg-[#111622] p-8 rounded-xl hover:-translate-y-1 transition-transform shadow-xl relative overflow-hidden group"
              >
                <div className="absolute top-0 left-0 w-1 h-full bg-[#4DD9AC] opacity-50 group-hover:opacity-100 transition-opacity"></div>
                <h3
                  style={{ fontFamily: FONTS.display }}
                  className="text-2xl font-bold text-white mb-6 pl-4"
                >
                  {dash.name}
                </h3>
                <ul className="space-y-4 pl-4">
                  {dash.points.map((pt: string, idx: number) => (
                    <li key={idx} className="flex items-start text-[#94A3B8]">
                      <span className="text-[#4DD9AC] mr-3 font-bold mt-1">
                        →
                      </span>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="text-sm text-[#94A3B8] font-bold uppercase tracking-widest mb-6">
            Industry Impact
          </div>
          <div
            className="text-2xl md:text-4xl font-bold text-white leading-relaxed max-w-4xl mx-auto"
            style={{ fontFamily: FONTS.display }}
          >
            {data.impact.split("·").map((stat: string, i: number, arr: any) => (
              <React.Fragment key={i}>
                <span className={i === 1 ? "text-[#4DD9AC]" : ""}>
                  {stat.trim()}
                </span>
                {i < arr.length - 1 && (
