...
import {
  ...
  type AnalyticsCompliance,
  type AnalyticsTrendForecast,
} from "../../lib/api";
import {
  DollarSign,
  Truck,
...
function LossTrendChart({ totalPrevented }: { totalPrevented: number }) {
  ...
  return (
    <div className="relative w-full" style={{ height: 200 }}>
      ...
      >
        ...
        {pts.map((v, i) => (
          <rect
            ...
            height={iH}
            fill="transparent"
            onMouseEnter={() => setHover({ i, x: tx(i), y: ty(v) })}
          />
        ))}
        {hover && (
          <>
      ...
      {hover && (
        <div
          className="absolute bg-[#111827] border border-[#1E2530] rounded-lg px-3 py-2 text-xs pointer-events-none z-10 shadow-xl"
          style={{
            left: Math.min((hover.x * 100) / 560 + 2, 70) + "%",
            top: "10%",
        ...
        >
          ...
          <div className="text-[#F1F5F9]">
            {kfmt(Math.round(pts[hover.i]))} prevented
          </div>
          <div className="text-[#64748B]">
            {Math.round(2 + Math.random() * 3)} interventions
          </div>
        </div>
      )}
    </div>
...
function TabOverview({
  ...
  const prevented =
    overview?.total_loss_prevented_inr ??
    summary?.estimated_savings_inr ??
    1420000;
  ...
  const kpis = [
    ...
    {
      icon: <Truck size={18} />,
      label: "Shipments Total",
      value: totalShips.toString(),
      trend: "+8%",
      up: true,
      color: C.blue,
    },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
        <div className="text-[10px] text-[#64748B] uppercase tracking-widest font-semibold mb-4 flex items-center gap-1.5">
          <Calendar size={12} /> THIS MONTH'S IMPACT
        </div>
        <div className="grid grid-cols-4 md:grid-cols-8 gap-3">
          {kpis.map((k) => (
            <div
              key={k.label}
              className="bg-[#0D1117] rounded-xl p-3 border border-[#1E2530]"
            >
              <div className="mb-1" style={{ color: k.color }}>
                {k.icon}
              </div>
              <div
              ...
              <div
                className={`text-[9px] font-bold mt-1 ${k.up ? "text-[#34D399]" : "text-[#F87171]"}`}
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <div className="text-sm font-bold text-[#F1F5F9]">
                ₹ Loss Prevented per Day
              </div>
              <div className="text-[11px] text-[#64748B]">
                Last 30 days · Hover for daily breakdown
              </div>
            </div>
          ...
          <div className="flex gap-4 text-[9px] text-[#64748B] mt-2">
            <span>
              <span className="inline-block w-3 h-0.5 bg-[#4DD9AC] rounded mr-1" />
              Loss prevented
            </span>
            <span>
              <span className="inline-block w-3 h-0.5 bg-[#1E2530] rounded mr-1" />
              Grid
            </span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          {[
            {
              label: "Avg Spoilage Risk Score",
              value: `${Math.round(avgRisk)} / 100`,
              sub: "↓ 8pts vs last month",
              good: true,
            },
            {
              label: "Excursions This Month",
              value: String(highRisk * 3 + 25),
              sub: "↓ 6 vs last month",
              good: true,
            },
            {
            ...
            <div
              key={i}
              className="bg-[#111827] border border-[#1E2530] rounded-xl px-4 py-3"
            >
              <div className="text-[10px] text-[#64748B] uppercase tracking-widest">
                {k.label}
              </div>
              <div className="text-xl font-black font-mono text-[#F1F5F9] mt-0.5">
                {k.value}
              </div>
              <div
                className={`text-[10px] font-semibold ${k.good ? "text-[#34D399]" : "text-[#F87171]"}`}
              >
                {k.sub}
              </div>
            </div>
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
        <div className="text-sm font-bold text-[#F1F5F9] mb-4 flex items-center gap-2">
          <BarChart2 size={16} /> With vs. Without Cargofy (estimated)
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-[#1E2530]">
                <th className="text-left py-2 px-3 text-[#64748B] font-semibold">
                  Metric
                </th>
                <th className="text-center py-2 px-3 text-[#4DD9AC] font-semibold">
                  WITH Cargofy
                </th>
                <th className="text-center py-2 px-3 text-[#EF4444] font-semibold">
                  WITHOUT Cargofy
                </th>
                <th className="text-center py-2 px-3 text-[#FBBF24] font-semibold">
                  Difference
                </th>
              </tr>
            </thead>
            <tbody className="divide-y divide-[#1E2530]">
              {[
                ...
                [
                  "Avg risk score",
                  String(Math.round(avgRisk)),
                  "78",
                  `${77 - Math.round(avgRisk)} pts better`,
                ],
              ].map(([m, w, wo, d]) => (
                <tr key={m} className="hover:bg-[#0D1117] transition-colors">
                  <td className="px-3 py-2.5 text-[#94A3B8] font-semibold">
                    {m}
                  </td>
                  <td className="px-3 py-2.5 text-center font-mono font-bold text-[#4DD9AC]">
                    {w}
                  </td>
                  <td className="px-3 py-2.5 text-center font-mono text-[#EF4444]">
                    {wo}
                  </td>
                  <td className="px-3 py-2.5 text-center font-mono font-bold text-[#FBBF24]">
                    {d}
                  </td>
                </tr>
              ))}
...
function TabOperations({
  ...
  const [hoverCell, setHoverCell] = useState<{ d: number; h: number } | null>(
    null,
  );
  ...
  const liveResolutionTimes =
    (operations?.alert_response_times ?? []).length > 0
      ? operations!.alert_response_times.map((r) => ({
          type: r.type,
          min: r.avg_response_min,
          color:
            r.avg_response_min < 5
              ? C.teal
              : r.avg_response_min < 10
                ? C.orange
                : C.red,
        }))
      : [];
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
          <div className="text-sm font-bold text-[#F1F5F9] mb-4 flex items-center gap-2">
            <Clock size={16} /> Shipment Stage Aging
          </div>
          <div className="space-y-3">
            {[
              {
              ...
              <div
                key={s.stage}
                className={`flex items-center justify-between px-3 py-2.5 rounded-lg border ${s.ok ? "border-[#1E2530] bg-[#0D1117]" : "border-[#EF4444]/30 bg-[#EF4444]/05"}`}
              >
                <div>
                ...
                <div className="flex items-center gap-2">
                  <span
                    ...
                    style={{ color: s.ok ? "#34D399" : "#EF4444" }}
                  >
                    {s.avg}
                  </span>
                  <span className={s.ok ? "text-[#34D399]" : "text-[#EF4444]"}>
                    {s.ok ? (
                      <CheckCircle size={14} />
                    ) : (
                      <ShieldAlert size={14} />
        ...
        <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
          <div className="text-sm font-bold text-[#F1F5F9] mb-4 flex items-center gap-2">
            <Zap size={16} /> Alert-to-Resolution Time
          </div>
          <div className="space-y-4">
            {(liveResolutionTimes.length > 0 ? liveResolutionTimes : []).map(
              (a) => (
                <div key={a.type}>
            ...
            <div className="text-[10px] text-[#64748B] pt-2 border-t border-[#1E2530]">
              Industry benchmark: ~28 min avg response. Cargofy AI: 4.2 min.{" "}
              <span className="text-[#34D399] font-bold">-85% faster.</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Excursion heatmap */}
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
        <div className="text-sm font-bold text-[#F1F5F9] mb-1 flex items-center gap-2">
          <Calendar size={16} /> Excursions by Time of Day
        </div>
        <div className="text-[11px] text-[#64748B] mb-4">
          Hover cells for details · Highest risk window highlights in red
        </div>
        <div className="overflow-x-auto">
          <div className="min-w-max">
            ...
            <div
              ...
              style={{ gridTemplateColumns: "48px repeat(12, 40px)" }}
            >
              <div />
              {HOURS.map((h) => (
                <div
                  key={h}
                  className="text-[9px] text-[#4A5568] text-center font-mono"
                >
                  {h}
                </div>
              ))}
            ...
            {heatmapData.map((row, di) => (
              <div
                ...
                style={{ gridTemplateColumns: "48px repeat(12, 40px)" }}
              >
                <div className="text-[10px] text-[#64748B] flex items-center pr-2">
                  {DAYS[di]}
                </div>
                {row.map((val, hi) => {
                  ...
                  return (
                    <div
                      key={hi}
                      className="relative h-7 rounded-sm cursor-pointer transition-all"
                      style={{
                        background: HEAT_COLORS[val],
                        outline: hovering ? `1px solid ${C.teal}` : "none",
                      }}
                    ...
                    >
                      {hovering && val > 0 && (
                        <div className="absolute z-20 bottom-full left-1/2 -translate-x-1/2 mb-1 bg-[#0D1117] border border-[#1E2530] rounded-lg px-2.5 py-1.5 text-[10px] whitespace-nowrap shadow-xl">
                          ...
                          <div style={{ color: HEAT_COLORS[val] }}>
                            {
        ...
        <div className="mt-4 bg-[#FBBF24]/08 border border-[#FBBF24]/25 rounded-lg px-4 py-2.5 text-[11px] text-[#FDE68A] flex items-center gap-2">
          ...
          <span>
            <strong>Insight:</strong> Highest risk window is 2 PM–5 PM on
            weekdays. Consider scheduling dairy shipments before noon.
          </span>
        </div>
      </div>
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#1E2530]">
          <div className="text-sm font-bold text-[#F1F5F9] flex items-center gap-2">
            <Award size={16} /> Driver Performance Leaderboard
          </div>
          <div className="flex gap-2">
            {[
              ...
              <button
                key={k}
                onClick={() => setSortDriver(k as any)}
          ...
          <thead className="bg-[#0D1117]">
            <tr>
              {[
                ...
                <th
                  key={h}
                  className="px-4 py-2.5 text-left text-[#64748B] font-semibold"
                >
                  {h}
                </th>
              ))}
          ...
          <tbody className="divide-y divide-[#1E2530]">
            {sortedDrivers.map((d, i) => {
              ...
              return (
                <tr
                  key={d.name}
                  className={`transition-colors ${i % 2 === 0 ? "bg-[#111827]" : "bg-[#0D1117]"} hover:bg-[#1A2235]`}
                >
                  <td className="px-4 py-3 text-lg">
                    {typeof d.medal === "string" && d.medal.length === 1
                      ? d.medal
                      : d.medal}
                  </td>
                  ...
                  <td
                    ...
                    style={{ color: d.avgDelay > 25 ? "#EF4444" : "#94A3B8" }}
                  >
                    <span className="flex items-center gap-1">
                      {d.avgDelay} min{" "}
                      {d.avgDelay > 25 && <AlertTriangle size={12} />}
                    </span>
                  </td>
                  <td
...
function TabRoutes({ routesData }: { routesData?: any[] }) {
  ...
  const insights = [
    {
      type: "warn",
      text: "Guwahati→Shillong has highest avg risk (68/100). Hill stretch after Jorabat drives 64% of excursions.",
      rec: "Schedule pre-6AM departures.",
    },
    {
      type: "warn",
      text: "Siliguri→Guwahati shows 18 excursions this month. Avg breach duration: 28 min — longest network-wide.",
      rec: "Mandatory reefer check at Siliguri hub.",
    },
    {
      type: "ok",
      text: "Delhi→Jaipur improved 12 points vs last month. Night dispatch policy implemented 18 Oct is working.",
      rec: "",
    },
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {insights.map((ins, i) => (
          <div
            key={i}
            className={`rounded-xl p-4 border ${ins.type === "warn" ? "bg-[#1A1200] border-[#FBBF24]/25" : "bg-[#0D2419] border-[#34D399]/25"}`}
          >
            ...
            {ins.rec && (
              <p className="text-[10px] text-[#FBBF24] mt-2 font-semibold">
                Suggest: {ins.rec}
              </p>
            )}
          </div>
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl overflow-hidden">
        <div className="flex items-center justify-between px-5 py-4 border-b border-[#1E2530]">
          <div className="text-sm font-bold text-[#F1F5F9] flex items-center gap-2">
            <Route size={16} /> Route Performance
          </div>
          ...
          <tbody className="divide-y divide-[#1E2530]">
            {sorted.map((r, i) => (
              <React.Fragment key={r.route}>
                <tr
                  onClick={() =>
                    setExpanded(expanded === r.route ? null : r.route)
                  }
                  className={`cursor-pointer transition-colors ${i % 2 === 0 ? "bg-[#111827]" : "bg-[#0D1117]"} hover:bg-[#1A2235]`}
                >
                  <td className="px-4 py-3 font-mono font-bold text-[#F1F5F9]">
                    {r.route}
                  </td>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-16 h-1.5 bg-[#1E2530] rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${r.avgRisk}%`,
                            background: r.perfColor,
                          }}
                        />
                      </div>
                      <span
                        className="font-mono font-bold"
                        style={{ color: r.perfColor }}
                      >
                        {r.avgRisk}
                      </span>
                    </div>
                ...
                {expanded === r.route && (
                  <tr>
                    <td
                      colSpan={6}
                      className="bg-[#0F1A2E] border-b border-[#1E3A5F]"
                    >
                      <div className="px-6 py-4 grid grid-cols-3 gap-4">
                        <div>
                          <div className="text-[10px] text-[#60A5FA] uppercase tracking-widest mb-2 font-semibold">
                            Top Excursion Causes
                          </div>
                          {[
                            "Temperature breach (afternoon peak)",
                            "Reefer degradation mid-route",
                            "Loading delays at origin hub",
                          ].map((c, ci) => (
                            <div
                              key={ci}
                              className="text-[11px] text-[#94A3B8] flex items-center gap-1.5 mb-1"
                            >
                        ...
                        <div>
                          ...
                          {[
                            ...
                            "Delivery hub: 91% pass",
                          ].map((c, ci) => (
                            <div
                              key={ci}
                              className="text-[11px] text-[#94A3B8] mb-1"
                            >
                              {c}
                            </div>
                          ))}
                        ...
                        <div>
                          ...
                          <div className="text-[11px] text-[#34D399] leading-relaxed">
                            Pre-dawn dispatch · Mandatory reefer inspection ·
                            Add checkpoint sensor at{" "}
                            {r.route.split("→")[1]?.trim()} hub
                          </div>
                        </div>
                      </div>
                    </td>
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
        <div className="text-sm font-bold text-[#F1F5F9] mb-4 flex items-center gap-2">
          <MapIcon size={16} /> Corridor Risk Map (India)
        </div>
        <div
          className="relative bg-[#0D1117] rounded-xl overflow-hidden"
          style={{ height: 280 }}
        >
          <svg
            viewBox="0 0 600 280"
          ...
          >
            ...
            {[
              220, 230, 225, 240, 255, 260, 270, 280, 285, 270, 260, 250, 240,
              230, 220,
            ].map((x, i, arr) => (
              <ellipse
                key={i}
            ...
            {(
              ...
              const fp = coords[from] || [280, 180],
                tp = coords[to] || [300, 200];
            ...
            {/* Legend */}
            <text x={10} y={20} fontSize="8" fill="#64748B">
              Route avg risk score shown on line
            </text>
            {[
              ["#34D399", "Good (≤35)"],
              ["#FBBF24", "Fair (36-60)"],
              ...
              <g key={col} transform={`translate(10,${240 + i * 16})`}>
                ...
                <text x={16} y={6} fontSize="7.5" fill="#94A3B8">
                  {lab}
                </text>
              </g>
            ))}
            <text x={10} y={235} fontSize="7.5" fill="#4A5568">
              Line thickness = shipment volume
            </text>
          </svg>
        </div>
      </div>
...
function TabProducts({ products }: { products?: AnalyticsProducts | null }) {
  ...
  const mergedProducts =
    (products?.product_matrix ?? []).length > 0
      ? products!.product_matrix.map((p) => {
          ...
          ).find((d) => d.name.toLowerCase() === p.product_type?.toLowerCase());
          return {
            name: p.product_type,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
        <div className="text-sm font-bold text-[#F1F5F9] mb-1 flex items-center gap-2">
          <Activity size={16} /> Product Sensitivity vs Network Risk
        </div>
        <div className="text-[11px] text-[#64748B] mb-4">
          Bubble size = shipment volume · Hover for details
        </div>
        <div
          className="relative bg-[#0D1117] rounded-xl overflow-hidden"
              ...
              return (
                ...
                >
                  <circle
                    ...
                    opacity={isH ? 0.9 : 0.6}
                    style={{
                      filter: isH ? `drop-shadow(0 0 10px ${p.color})` : "none",
                      transition: "all 0.2s",
                    }}
                  />
                  <text
                  ...
                  {isH && (
                    <g>
                      ...
                      <text
                        ...
                        fill="#94A3B8"
                      >
                        {p.excursions} excursions · {p.vol} trips
                      </text>
                      <text
                        x={cx}
                        y={cy - r - 6}
                        ...
                        fill={p.color}
                      >
                        Risk: {p.risk} · Sensitivity: {p.sensitivity}
                      </text>
                    </g>
                  )}
                </g>
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
        <div className="text-sm font-bold text-[#F1F5F9] mb-4 flex items-center gap-2">
          <BarChart2 size={16} /> Excursion Frequency by Product
        </div>
        <div className="space-y-3">
          {[...mergedProducts]
            .sort((a, b) => b.excursions - a.excursions)
            .map((p) => (
              <div key={p.name} className="flex items-center gap-3">
                <span className="w-16 text-xs text-[#94A3B8] text-right shrink-0">
                  {p.icon} {p.name}
                </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {mergedProducts
          .filter((p) => p.excursions > 5)
          .map((p) => (
            <div
              key={p.name}
              className="bg-[#0D1117] border border-[#1E2530] rounded-xl p-4"
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span
                  ...
                  style={{ color: p.color }}
                >
                  <Lightbulb size={14} /> {p.name}
                </span>
              </div>
              <div className="text-[11px] text-[#64748B] mb-1">
                Peak excursion: {p.peak}
              </div>
  ...
  const overallScore = complianceMetrics.length
    ? Math.round(
        (complianceMetrics.reduce(
          (s, m) => s + Math.min((m.value / m.target) * 100, 100),
          0,
        ) /
    ...
    <div className="space-y-6">
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
        <div className="flex items-center justify-between mb-5">
          <div>
            <div className="text-sm font-bold text-[#F1F5F9] flex items-center gap-2">
              <ClipboardCheck size={16} /> Compliance Dashboard — October 2024
            </div>
            <div className="text-[11px] text-[#64748B] mt-0.5">
              Audit-ready summary. Target ranges shown per metric.
            </div>
          </div>
          <div className="text-center">
            ...
            <div className="text-[10px] text-[#34D399] font-bold uppercase tracking-widest flex items-center justify-center gap-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {complianceMetrics.map((m) => {
            ...
            return (
              <div
                key={m.label}
                className={`flex items-center justify-between px-4 py-3 rounded-xl border ${passing ? "border-[#1E2530] bg-[#0D1117]" : "border-[#FBBF24]/30 bg-[#1A1200]"}`}
              >
                <div>
                  <div className="text-xs font-semibold text-[#CBD5E1]">
                    {m.label}
                  ...
                  <div className="w-20 h-1.5 bg-[#1E2530] rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        background: passing ? "#34D399" : "#FBBF24",
                      }}
                    />
                  </div>
                  <span
                    className="font-mono font-bold w-14 text-right"
                    style={{ color: passing ? "#34D399" : "#FBBF24" }}
                  >
                    {m.value}
                    {m.unit}
                  </span>
                  <span
                    className={passing ? "text-[#34D399]" : "text-[#FBBF24]"}
                  >
                    {passing ? (
                      <CheckCircle size={14} />
                    ) : (
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl overflow-hidden">
        <div className="px-5 py-4 border-b border-[#1E2530]">
          <div className="text-sm font-bold text-[#F1F5F9] flex items-center gap-2">
            <BarChart2 size={16} /> Per-Shipment Compliance Log
          </div>
        </div>
        <div className="overflow-x-auto">
          <table className="w-full text-xs">
            ...
            <tbody className="divide-y divide-[#1E2530]">
              {(compliance?.shipment_log?.length
                ? compliance.shipment_log.slice(0, 8)
                : shipments.length
                  ? shipments.slice(0, 8)
                  : Array.from({ length: 5 }).map((_, i) => ({
                      id: String(i),
                      shipment_code: `AXN-${2000 + i * 91}`,
                      product_type: [
                        "dairy",
                        "seafood",
                        "pharma",
                      ...
                      status: "delivered",
                      compliance_pct: 80 + i * 4,
                      sla_met: i < 4,
                      max_temp_breach_min: i * 3,
                      total_excursions: i,
                    }))
              ).map((s: any, i) => {
                const overall =
                  (s.compliance_pct ?? 90) >= 90 && (s.sla_met ?? true);
                ...
                return (
                  <tr
                    key={s.id}
                    className={`${i % 2 === 0 ? "bg-[#111827]" : "bg-[#0D1117]"} hover:bg-[#1A2235] transition-colors`}
                  >
                    <td className="px-4 py-2.5 font-mono font-bold text-[#4DD9AC]">
                      {s.shipment_code}
                    </td>
                    ...
                    <td className="px-4 py-2.5">
                      <span
                        className={`flex items-center gap-1 ${tempPass ? "text-[#34D399]" : "text-[#EF4444]"}`}
                      >
                        {tempPass ? (
                          <CheckCircle size={12} />
                        ) : (
                    ...
                    <td className="px-4 py-2.5">
                      <span
                        className={`flex items-center gap-1 ${humPass ? "text-[#34D399]" : "text-[#EF4444]"}`}
                      >
                        {humPass ? (
                          <CheckCircle size={12} />
                        ) : (
                    ...
                    <td className="px-4 py-2.5">
                      <span
                        className={`flex items-center gap-1 ${otPass ? "text-[#34D399]" : "text-[#EF4444]"}`}
                      >
                        {otPass ? (
                          <CheckCircle size={12} />
                        ) : (
                    ...
                    <td className="px-4 py-2.5">
                      <span
                        className={`flex items-center gap-1 ${podPass ? "text-[#34D399]" : "text-[#EF4444]"}`}
                      >
                        {podPass ? (
                          <CheckCircle size={12} />
                        ) : (
                    ...
                    <td className="px-4 py-2.5">
                      <span
                        className={`text-[10px] font-bold px-2 py-0.5 rounded-full flex items-center gap-1 w-max ${overall ? "bg-[#34D399]/15 text-[#34D399]" : "bg-[#EF4444]/15 text-[#F87171]"}`}
                      >
                        {overall ? <CheckCircle size={12} /> : <X size={12} />}{" "}
                        {overall ? "PASS" : "FAIL"}
                      </span>
                    </td>
                  </tr>
      ...
      {/* Export panel */}
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
        <div className="text-sm font-bold text-[#F1F5F9] mb-4">
          📤 Export Options
        </div>
        <div className="flex items-end gap-3 mb-4">
          <div>
            ...
            <input
              type="date"
              value={exportRange[0]}
              onChange={(e) => setExportRange([e.target.value, exportRange[1]])}
          ...
          <div>
            ...
            <input
              type="date"
              value={exportRange[1]}
              onChange={(e) => setExportRange([exportRange[0], e.target.value])}
              className="bg-[#0D1117] border border-[#1E2530] rounded-lg px-3 py-2 text-xs text-[#CBD5E1] focus:outline-none focus:border-[#4DD9AC]/40"
            />
          </div>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {[
            ...
            },
            {
              icon: "📊",
              label: "Shipment Data",
              sub: "Excel · All fields",
              color: C.blue,
            },
            {
              icon: "🗂️",
              label: "Excursion Log",
              sub: "CSV · With timestamps",
              color: C.purple,
            },
            {
              icon: "📋",
    ...
    <div className="space-y-6">
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <div className="text-[11px] text-[#64748B] mt-0.5">
              ...
              · Confidence:{" "}
              <span style={{ color: confidence > 70 ? "#34D399" : "#FBBF24" }}>
                {confidence.toFixed(0)}%
              </span>
              {isMock && (
                <span className="ml-2 text-[#A78BFA] text-[9px] uppercase tracking-widest font-bold">
                  DEMO
                </span>
              )}
            </div>
          ...
          <div className="text-right">
            ...
            >
              {lossRisk >= 100000
                ? `₹${(lossRisk / 100000).toFixed(1)}L`
                : `₹${(lossRisk / 1000).toFixed(0)}K`}
            </div>
            ...
            return (
              <div key={i} className="flex-1 flex flex-col items-center gap-1">
                <div
                  ...
                  style={{ color: isHigh ? "#EF4444" : "#64748B" }}
                >
                  {e.events}
                </div>
                <div
                ...
                {isHigh && (
                  <div className="text-[8px] text-[#EF4444] font-bold">⚠</div>
                )}
              </div>
            );
          })}
        ...
        <div className="flex items-center gap-4 mt-3 text-[9px] text-[#64748B]">
          <span className="flex items-center gap-1">
            <span className="w-3 h-3 rounded-sm bg-[#4DD9AC40] border border-[#4DD9AC50]" />{" "}
            Normal
          </span>
          <span className="flex items-center gap-1">
            <span className="w-3 h-3 rounded-sm bg-[#EF444490] border border-[#EF4444]" />{" "}
            High Risk Day
          </span>
        </div>
      </div>
      ...
      {highDays.length > 0 && (
        <div className="bg-[#1A0F0F] border border-[#EF4444]/30 rounded-xl p-4">
          <div className="text-sm font-bold text-[#F87171] mb-2">
            🚨 High-Risk Days Predicted
          </div>
          <div className="flex flex-wrap gap-2">
            {highDays.map((d) => (
              <span
                key={d}
                className="font-mono text-xs bg-[#EF4444]/10 border border-[#EF4444]/30 text-[#F87171] px-2.5 py-1 rounded-lg font-bold"
              >
                {d}
              </span>
            ))}
          ...
          <div className="text-[11px] text-[#94A3B8] mt-2">
            Increase monitoring frequency and pre-position cold hubs on these
            days.
          </div>
        </div>
      )}
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-2xl p-5">
        ...
        <div className="space-y-3">
          {recs.map((rec, i) => (
            <div
              key={i}
              className="flex items-start gap-3 bg-[#0D1117] rounded-xl px-4 py-3 border border-[#1E2530]"
            >
              <div
                className="w-5 h-5 shrink-0 rounded-full flex items-center justify-center text-[10px] font-black mt-0.5"
                style={{
                  background: "#4DD9AC20",
                  color: "#4DD9AC",
                  border: "1px solid #4DD9AC40",
                }}
              >
                {i + 1}
              </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          {
            label: "Peak Risk Day",
            value: highDays[0]?.slice(5) ?? "Wed",
            icon: "📅",
            color: "#EF4444",
          },
          {
            label: "Events Predicted",
            value: String(events.reduce((s, e) => s + e.events, 0)),
            icon: "⚡",
            color: "#FBBF24",
          },
          {
          ...
          <div
            key={k.label}
            className="bg-[#111827] border border-[#1E2530] rounded-xl p-4"
          >
...
const REPORT_PROMPTS = [
  {
    ...
    icon: "📊",
    desc: "Board-ready cold-chain performance summary",
  },
  {
    id: "ops",
    label: "Operations Deep-Dive",
    icon: "⚙️",
    desc: "Driver performance, routes, SLA breaches",
  },
  {
    id: "risk",
    label: "Risk Intelligence",
    icon: "🛡️",
    desc: "Incidents, SHAP analysis, predictive outlook",
  },
  {
    id: "finance",
    label: "Financial Impact",
    icon: "💰",
    desc: "Loss prevented by route, driver, product",
  },
  {
    id: "sustain",
    label: "Sustainability",
    icon: "🌱",
    desc: "CO2 avoided, food waste, ESG indicators",
  },
];

const REPORT_SECTIONS: Record<
  string,
  ...
  exec: [
    {
      ...
      body: "Cargofy prevented Rs14.2L in cargo spoilage loss this month across 47 active cold-chain shipments in Northeast India. The AI intervention system autonomously resolved 89% of temperature breach events with zero human escalation.",
    },
    {
      heading: "🚛 Fleet Performance",
      body: "On-time delivery rate stands at 94.2%, up 2.1% from last month. The Guwahati to Shillong corridor remains the highest-risk route with an average risk score of 71/100. 3 of 14 reroute suggestions were executed, saving 6.4 hours of exposure time.",
    },
    {
      heading: "🤖 AI Agent Activity",
      body: "The Gemini Negotiator Agent secured 8 emergency cold storage slots autonomously. The Risk Agent triggered 34 WhatsApp alerts to drivers with an ACK rate of 87.3%. Route Optimizer proposed 14 alternative routes, 12 were accepted.",
    },
    {
      heading: "⚡ Key Risks Ahead",
      body: "Monsoon season onset in 3 weeks historically increases ambient temperature variance by +8C. AI model predicts a 22% spike in CRITICAL incidents during June 20 to July 15. Recommend pre-positioning 3 cold hubs along NH-6 corridor before monsoon.",
    },
    {
      heading: "✅ Recommendations",
      body: "1. Activate pre-monsoon cold hub protocol on NH-6 and NH-27. 2. Increase sensor polling to 2 minutes for CRITICAL shipments. 3. Deploy Gemini Negotiator to auto-book slots during high-risk windows. 4. Brief fleet managers on autonomous escalation policy.",
    },
  ],
  ops: [
    {
      heading: "⚙️ Operations Summary",
      body: "47 shipments monitored. Avg transit time: 4h 22min. Top driver: Rajesh Kumar (98.1% ACK rate, 0 excursions, 5 trips). Bottom performer: Driver ID-0021 (2 excursions, 68% ACK rate).",
    },
    {
      heading: "📍 Route Analysis",
      body: "Guwahati to Shillong: 12 trips, avg risk 71 Poor. Silchar to Agartala: 8 trips, avg risk 38 Fair. Dimapur to Kohima: 6 trips, avg risk 18 Great. NH-6 bypass reduces avg risk by 22 points when used.",
    },
    {
      heading: "🚨 SLA Breaches",
      body: "3 SLA breaches recorded. All 3 were on Guwahati to Shillong route. Smart contract penalty clauses triggered for 2 consignees. Total exposure: Rs82,000. All alerted within 4.2 minutes on average.",
    },
    {
      heading: "🔧 Interventions",
      body: "1. Mandate NH-6 bypass for CRITICAL dairy and seafood shipments. 2. Driver-0021 requires reefer training. 3. Consider Shillong Hub capacity expansion, currently at 89% utilization during peak hours.",
    },
  ],
  risk: [
    {
      heading: "🛡️ Risk Intelligence",
      body: "AI Risk Model identified 3 dominant factors: (1) Reefer unit degradation contributes 28% of risk score variance, (2) Ambient temp above 35C adds +9 risk points, (3) Transit delays beyond 20 min compound spoilage risk by 1.4x.",
    },
    {
      heading: "⚠️ Critical Incidents",
      body: "6 CRITICAL events recorded. 4 resolved autonomously by AI agents. 2 required human escalation. All 6 were temperature breaches exceeding safe band by 3C+. Shipments: AXN-2091, AXN-1874, AXN-2143, AXN-1990, AXN-2201, AXN-2048.",
    },
    {
      heading: "🔮 Predictive Outlook 14 Days",
      body: "Model confidence 78%. Predicted CRITICAL incidents: 8 to 12. High-risk corridors: Guwahati to Meghalaya (ambient heat spike), Silchar to Imphal (road degradation). Recommendation: book 5 additional cold hub slots before June 20.",
    },
  ],
  finance: [
    {
      heading: "💰 Financial Impact",
      body: "Total loss prevented: Rs14.2L. AI system operating cost: Rs1.1L. Net ROI: 12.9x. Average prevented per shipment: Rs30,200. Highest-value save: AXN-2091 (Rs1.84L dairy cargo rerouted to Meghalaya Hub with zero spoilage).",
    },
    {
      heading: "📉 Loss by Route",
      body: "Guwahati to Shillong: Rs6.1L prevented (43% of total). Silchar to Agartala: Rs3.8L. Dimapur to Kohima: Rs4.3L. Emergency cold hub diversions accounted for Rs4.2L in prevented losses, highest ROI intervention type.",
    },
    {
      heading: "🏆 Top Products",
      body: "Dairy/milk: Rs5.4L prevented. Seafood: Rs4.1L. Pharma: Rs2.9L. Fruits: Rs1.8L. Dairy remains highest-risk and highest-value category, recommend priority AI monitoring for all dairy shipments.",
    },
  ],
  sustain: [
    {
      heading: "🌱 Sustainability Summary",
      body: "Cargofy AI avoided an estimated 1.8 metric tons of CO2 equivalent emissions from wasted food production, transport, and disposal. Equivalent to taking 3.9 cars off the road for a month.",
    },
    {
      heading: "🥗 Food Security Impact",
      body: "An estimated 4,200 meals were preserved. This aligns with UN SDG 12.3 (halving food waste by 2030). Communities served: 7 districts of Assam, Meghalaya, Nagaland, and Tripura.",
    },
    {
      heading: "📋 ESG Indicators",
      body: "Spoilage rate: 2.1% vs industry average 11.4%. Emissions per ton-km: 18g CO2. Driver welfare index: 84/100. Cold hub utilization efficiency: 91%, reducing idle refrigeration energy by 34%.",
    },
  ],
};

function GeminiReportGenerator({
  summary,
  shipments,
  alerts,
}: {
  ...
  function generateReport() {
    ...
    script.forEach((sec, idx) => {
      ...
      for (let i = 0; i < chars.length; i += BATCH) {
        ...
        const t2 = setTimeout(
          () => setStreamedText((prev) => prev + captured),
          delay + (i / BATCH) * 15,
        );
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0D1A2E] via-[#111827] to-[#0A0D14] border border-[#1E3A5F] rounded-2xl p-6 relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 30% 50%, rgba(96,165,250,0.06) 0%, transparent 60%)",
          }}
        />
        <div className="flex items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-lg font-black text-[#F1F5F9]">
                Gemini AI Report Generator
              </span>
              {generating && (
                <span className="text-[10px] text-[#60A5FA] animate-pulse bg-[#60A5FA]/10 border border-[#60A5FA]/30 px-2 py-0.5 rounded-full">
                  ● GENERATING
                </span>
              )}
              {done && (
                <span className="text-[10px] text-[#34D399] bg-[#34D399]/10 border border-[#34D399]/30 px-2 py-0.5 rounded-full">
                  ✓ COMPLETE
                </span>
              )}
            </div>
            <p className="text-sm text-[#64748B] max-w-xl">
              Gemini reads your live Supabase analytics and writes a full
              structured report. Select a type, then click Generate.
            </p>
          </div>
          <div className="shrink-0 text-right">
            <div className="text-2xl font-black font-mono text-[#4DD9AC]">
              Rs.{(prevented / 100000).toFixed(1)}L
            </div>
            <div className="text-[10px] text-[#64748B]">
              loss prevented this month
            </div>
          </div>
        </div>
      </div>
        ...
        {done && (
          <motion.button
            ...
            onClick={() => {
              ...
              a.href = url;
              a.download = `cargofy_${selectedPrompt}_report.txt`;
              a.click();
            }}
      ...
      <AnimatePresence>
        {(sections.length > 0 || generating) && (
          <motion.div
            ...
            className="bg-[#080B12] border border-[#1E2530] rounded-2xl overflow-hidden"
          >
            <div className="px-6 py-4 border-b border-[#1E2530] bg-gradient-to-r from-[#0D1117] to-[#080B12] flex items-center justify-between">
              ...
              {done && (
                <span className="text-[10px] text-[#34D399] bg-[#34D399]/10 border border-[#34D399]/20 px-2 py-0.5 rounded-full font-bold">
                ...
                <div className="px-6 py-5">
                  ...
                  <p className="text-sm text-[#64748B] leading-relaxed">
                    ...
                    <motion.span
                      ...
                      className="inline-block w-0.5 h-4 bg-[#60A5FA] ml-0.5 align-middle"
                    />
                  </p>
                </div>
              )}
              ...
              <div className="px-6 py-3 border-t border-[#1E2530] bg-[#0A0D14] flex items-center gap-3">
                <div className="flex-1 h-1 bg-[#1E2530] rounded-full overflow-hidden">
                  <motion.div
                    ...
                    animate={{
                      width: `${Math.round((sections.length / REPORT_SECTIONS[selectedPrompt].length) * 100)}%`,
                    }}
                    transition={{ duration: 0.5 }}
                  />
                </div>
                <span className="text-[10px] text-[#64748B] font-mono shrink-0">
                  {sections.length}/{REPORT_SECTIONS[selectedPrompt].length}{" "}
                  sections
                </span>
              </div>
            )}
        ...
        {[
          {
            ...
            label: "Loss Prevented",
            value: `Rs.${((summary?.estimated_savings_inr ?? 1420000) / 100000).toFixed(1)}L`,
            color: "#4DD9AC",
          },
          {
            icon: <Truck size={14} />,
          ...
          },
          {
            ...
            label: "High Risk Now",
            value: String(
              shipments.filter((s) => (s.current_risk?.risk_score ?? 0) > 0.6)
                .length,
            ),
            color: "#F97316",
          },
          ...
          <div
            key={k.label}
            className="bg-[#111827] border border-[#1E2530] rounded-xl p-4 flex items-center gap-3"
          >
            <div
...
export function CargofyAnalytics() {
  ...
  const [operations, setOperations] = useState<AnalyticsOperations | null>(
    null,
  );
  const [routes, setRoutes] = useState<AnalyticsRoutes | null>(null);
  const [products, setProducts] = useState<AnalyticsProducts | null>(null);
  const [compliance, setCompliance] = useState<AnalyticsCompliance | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    Promise.all([getShipments("all"), getAlerts(), getAnalyticsSummary()])
      .then(([s, a, sm]) => {
        setShipments(s);
        setAlerts(a);
        setSummary(sm);
  ...
  const liveDrivers =
    (operations?.driver_leaderboard ?? []).length > 0
  ...
  const liveRoutes =
    (routes?.route_performance ?? []).length > 0
    ...
    >
      ...
      <div className="shrink-0 bg-[#0D1117] border-b border-[#1E2530] px-5 flex items-center gap-1">
        ...
        <div className="ml-auto py-2">
          {loading && (
            <span className="text-[10px] text-[#4DD9AC] animate-pulse flex items-center gap-1">
              <span className="w-1.5 h-1.5 bg-[#4DD9AC] rounded-full animate-pulse" />
              Loading data…
            </span>
          )}
        </div>
