...
interface ThreadMsg {
  time: string;
  who: "system" | "outbound" | "inbound" | "escalation";
  text: string;
  read?: boolean;
  name?: string;
}
...
const PRODUCT_ICONS: Record<string, React.ReactNode> = {
  dairy: <ThermometerSnowflake size={14} />,
  milk: <ThermometerSnowflake size={14} />,
  seafood: <ThermometerSnowflake size={14} />,
  fish: <ThermometerSnowflake size={14} />,
  frozen: <ThermometerSnowflake size={14} />,
  meat: <ThermometerSnowflake size={14} />,
  produce: <Package size={14} />,
  vegetables: <Package size={14} />,
  pharma: <Activity size={14} />,
  fruits: <Package size={14} />,
  other: <Package size={14} />,
};
const pIcon = (t?: string): React.ReactNode =>
  PRODUCT_ICONS[t?.toLowerCase() ?? ""] ?? <Package size={14} />;
...
const TEMPLATE_ALERTS = [
  {
    ...
    alertType: "Temperature Breach",
    typeIcon: <ThermometerSnowflake size={14} />,
    driver: "Ramesh Kumar",
    channel: "WhatsApp",
    shipCode: "AXN-2091",
    route: "Guwahati → Shillong",
    productIcon: <ThermometerSnowflake size={14} />,
    resolved: false,
    acknowledged: false,
    escalated: false,
    escalateCountdown: 262,
    triggerText:
      "Cargo temp 9.8°C — 3.8° above safe max (6°C). Breach ongoing 22 min.",
    ...
    message_body: "⚠️ URGENT: Cargo temp 9.8°C — safe max 6°C.",
    thread: [
      {
        time: "08:22:04",
        who: "system" as const,
        text: "Alert triggered — Temperature Breach on AXN-2091",
      },
      {
        time: "08:22:14",
        who: "outbound" as const,
        text: "⚠️ URGENT: Cargo temp 9.8°C — safe max 6°C. Please check reefer immediately. AXN-2091",
        read: false,
      },
      {
        time: "08:24:00",
        who: "escalation" as const,
        text: "Auto-escalation triggered — no ack in 2 min. Escalating to Fleet Manager Sunil Mehta.",
      },
      {
        time: "08:24:05",
        who: "outbound" as const,
        text: "Driver Ramesh unresponsive. Temp breach on AXN-2091. Please call or take action.",
        read: true,
        name: "Sunil Mehta",
      },
      {
        time: "08:26:14",
        who: "inbound" as const,
        text: "Calling driver now",
        name: "Sunil Mehta",
      },
    ],
  },
  {
    ...
    typeIcon: <Droplets size={14} />,
    driver: "Suresh Pandey",
    channel: "WhatsApp",
    shipCode: "AXN-3044",
    route: "Jorhat → Kohima",
    productIcon: <ThermometerSnowflake size={14} />,
    ...
    escalateCountdown: 0,
    triggerText:
      "Humidity 84% — above 75% safe limit. Seafood packaging at risk.",
    ...
    channel_raw: "whatsapp",
    message_body: "💧 Humidity alert: 84% detected.",
    thread: [
      {
        time: "07:45:00",
        who: "system" as const,
        text: "Humidity spike detected — 84% on AXN-3044",
      },
      {
        time: "07:45:10",
        who: "outbound" as const,
        text: "💧 Humidity 84% — safe limit 75%. Check cargo packaging. Seafood SOP: seal open containers.",
        read: true,
      },
      {
        time: "07:47:20",
        who: "inbound" as const,
        text: "Checking packaging now",
        name: "Suresh Pandey",
      },
      {
        time: "07:52:00",
        who: "inbound" as const,
        text: "Resealed the boxes. Humidity still 81% but dropping slowly.",
        name: "Suresh Pandey",
      },
    ],
  },
  {
    id: "t3",
    severity: "CRITICAL" as const,
    alertType: "Reefer Failure",
    typeIcon: <Zap size={14} />,
    driver: "Dev Nair",
    channel: "WhatsApp",
    shipCode: "AXN-2841",
    route: "Dibrugarh → Itanagar",
    productIcon: <Activity size={14} />,
    resolved: false,
    acknowledged: false,
    escalated: true,
    escalateCountdown: 0,
    triggerText:
      "Reefer compressor stopped. Temp rising at 1.2°C/min. Pharma cargo critical.",
    ...
    channel_raw: "call",
    message_body: "🚨 CRITICAL: Reefer failure on AXN-2841.",
    thread: [
      {
        time: "06:58:00",
        who: "system" as const,
        text: "Reefer failure alert — AXN-2841 pharma cargo",
      },
      {
        time: "06:58:14",
        who: "outbound" as const,
        text: "🚨 CRITICAL: Reefer failure on AXN-2841. Stop immediately and call cold hub. Temp rising 1.2°C/min.",
        read: false,
      },
      {
        time: "07:00:00",
        who: "escalation" as const,
        text: "Driver unresponsive after 2 min. Auto-escalated to Fleet Manager + Operations Lead.",
      },
      {
        time: "07:00:10",
        who: "outbound" as const,
        text: "URGENT: Dev Nair (AXN-2841) not responding. Reefer failure. Please call immediately.",
        read: true,
        name: "Ananya Singh",
      },
      {
        time: "07:04:00",
        who: "inbound" as const,
        text: "Called driver. He's pulled over at NH-37. Calling nearest cold hub now.",
        name: "Ananya Singh",
      },
    ],
  },
  {
    ...
    typeIcon: <Clock size={14} />,
    driver: "Anuj Sharma",
    channel: "Push",
    shipCode: "AXN-1998",
    route: "Mumbai → Pune",
    productIcon: <Package size={14} />,
    resolved: true,
    acknowledged: true,
    escalated: false,
    escalateCountdown: 0,
    triggerText:
      "Delay +28 min — SLA at risk. Rerouted via Expressway alternate.",
    created_at: new Date(Date.now() - 110 * 60000).toISOString(),
    delivered: true,
    shipment_id: "s4",
    shipment_code: "AXN-1998",
    recipient_phone: "+919876543213",
    channel_raw: "push",
    message_body: "⏱ Delay +28 min on AXN-1998.",
    thread: [
      {
        time: "06:10:00",
        who: "system" as const,
        text: "Delay alert — AXN-1998 +28 min behind schedule",
      },
      {
        time: "06:10:10",
        who: "outbound" as const,
        text: "📍 Update: AXN-1998 delayed by 28 min. Current ETA revised. Please update route if possible.",
        read: true,
      },
      {
        time: "06:11:30",
        who: "inbound" as const,
        text: "On it. Taking alternate via Expressway inner ring.",
        name: "Anuj Sharma",
      },
      {
        time: "06:22:00",
        who: "system" as const,
        text: "Resolved — Delivered on time. Resolution: 11 min 42 sec.",
      },
    ],
  },
  {
    ...
    escalateCountdown: 0,
    triggerText:
      "GPS signal lost for 12 min in tunnel zone. Signal restored auto.",
    ...
    channel_raw: "sms",
    message_body: "📡 GPS signal lost on AXN-2094.",
    thread: [
      {
        time: "05:40:00",
        who: "system" as const,
        text: "GPS signal lost — AXN-2094 in tunnel zone",
      },
      {
        time: "05:52:00",
        who: "system" as const,
        text: "GPS signal restored. No action required.",
      },
    ],
  },
];
...
const TEMPLATES = [
  ...
  },
  {
    ...
    vars: ["{shipment_id}", "{destination}"],
    default: false,
  },
  {
    id: "tpl6",
    icon: <ShieldAlert size={14} />,
    name: "Immediate Cooling Action",
    product: "Pharma",
      ...
      style={{
        ...
        background: selected
          ...
          : a.resolved
            ...
            : `${color}05`,
        boxShadow: selected
          ? `0 0 0 1px ${color}30, 0 4px 20px rgba(0,0,0,0.3)`
          : "0 2px 8px rgba(0,0,0,0.2)",
        animation:
          isCrit && !a.resolved && !a.escalated
            ? "pulseBorder 2.5s ease-in-out infinite"
            : undefined,
      }}
    >
      ...
      {!a.resolved && !a.acknowledged && a.escalateCountdown > 0 && (
        <div
          className={`absolute top-2 right-2 text-[9px] font-bold px-2 py-0.5 rounded-full font-mono ${a.escalateCountdown < 120 ? "bg-[#EF4444]/20 text-[#F87171]" : "bg-[#FBBF24]/15 text-[#FBBF24]"}`}
        >
          ⏰ escalate in {fmtCountdown(a.escalateCountdown)}
        </div>
      )}
      {a.escalated && !a.resolved && (
        <div className="absolute top-2 right-2 text-[9px] font-bold px-2 py-0.5 rounded-full bg-[#A78BFA]/20 text-[#A78BFA]">
          🚨 ESCALATED
        </div>
      )}
      ...
      {/* Trigger text */}
      <div className="text-[11px] text-[#94A3B8] leading-relaxed line-clamp-2 mb-2">
        {a.triggerText}
      </div>
      ...
      <div className="mt-2 h-0.5 bg-[#1E2530] rounded-full overflow-hidden">
        <div
          ...
          style={{
            width: a.resolved ? "100%" : a.acknowledged ? "60%" : "30%",
            background: a.resolved ? "#34D399" : color,
          }}
        />
      </div>
    </button>
...
function AlertDetail({
  ...
  const [detailTab, setDetailTab] = useState<"thread" | "agent" | "playbook">(
    "thread",
  );
      ...
      <div className="shrink-0 px-5 py-4 border-b border-[#1E2530] bg-[#0A0D14] sticky top-0 z-10">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            <span
              className="text-xs font-black px-2 py-1 rounded-full flex items-center gap-1.5"
              style={{ color, background: `${color}18` }}
            >
              {a.typeIcon} {a.severity}
            </span>
            <span className="font-mono text-sm font-black text-[#F1F5F9]">
              {a.alertType}
            </span>
          </div>
          <button
            onClick={() => navigate(`/shipments/${a.shipment_id}`)}
            className="text-[10px] text-[#64748B] hover:text-[#4DD9AC] border border-[#1E2530] px-2 py-1 rounded flex items-center gap-1 transition-colors"
          >
        ...
        <div className="flex gap-1 mt-3">
          {(
            ...
            ] as { k: "thread" | "agent" | "playbook"; label: string }[]
          ).map((t) => (
            <button
              key={t.k}
      ...
      {detailTab === "thread" && (
        <>
          ...
          >
            {thread.map((msg, i) => {
              if (msg.who === "system")
                return (
                  <div key={i} className="flex justify-center">
                    <span className="text-[10px] text-[#4A5568] bg-[#111827] border border-[#1E2530] px-3 py-1 rounded-full font-mono">
                      {msg.time} · {msg.text}
                    </span>
                  </div>
                );
              if (msg.who === "escalation")
                return (
                  <div key={i} className="flex justify-center">
                    <span className="text-[10px] text-[#A78BFA] bg-[#A78BFA]/08 border border-[#A78BFA]/25 px-3 py-1.5 rounded-lg font-semibold max-w-xs text-center">
                      {msg.time} · 🚨 {msg.text}
                    </span>
                  </div>
                );
              ...
              return (
                <div
                  key={i}
                  className={`flex flex-col gap-0.5 ${isOut ? "items-end" : "items-start"}`}
                >
                  {!isOut && msg.name && (
                  ...
                  <div
                    className={`text-[9px] text-[#4A5568] px-1 flex items-center gap-1 ${isOut ? "" : "flex-row-reverse gap-1"}`}
                  >
                    <span>{msg.time}</span>
                    {isOut && (
                      <span style={{ color: msg.read ? "#34D399" : "#EF4444" }}>
                        {msg.read ? "✓✓ Read" : "✓ Delivered · UNREAD"}
                      </span>
                    )}
                  </div>
                </div>
          ...
          <div className="shrink-0 px-5 py-3 border-t border-[#1E2530]">
            <div className="text-[9px] text-[#64748B] uppercase tracking-widest mb-2">
              Quick Actions
            </div>
            ...
            {noteMode && (
              <div className="flex gap-2 mb-2">
                <textarea
                  ...
                  className="flex-1 bg-[#111827] border border-[#1E2530] rounded-lg px-3 py-2 text-xs text-[#CBD5E1] placeholder-[#4A5568] focus:outline-none focus:border-[#4DD9AC]/40 resize-none"
                  rows={2}
                />
                <button
                  onClick={sendReply}
                  className="bg-[#4DD9AC]/10 border border-[#4DD9AC]/30 text-[#4DD9AC] px-3 rounded-lg text-xs hover:bg-[#4DD9AC]/20 transition-colors"
                >
                  Send
                </button>
              </div>
            ...
            <div className="flex gap-2">
              <button
                onClick={() => navigate(`/shipments/${a.shipment_id}`)}
                className="flex-1 text-[10px] text-[#64748B] border border-[#1E2530] py-1.5 rounded-lg hover:text-[#4DD9AC] hover:border-[#4DD9AC]/30 transition-colors flex items-center justify-center gap-1.5"
              >
                <Package size={12} /> Open Shipment Detail{" "}
                <ArrowRight size={10} />
              </button>
              <button
                onClick={() => navigate(`/live-tracking`)}
                className="flex-1 text-[10px] text-[#64748B] border border-[#1E2530] py-1.5 rounded-lg hover:text-[#60A5FA] hover:border-[#60A5FA]/30 transition-colors flex items-center justify-center gap-1.5"
              >
  ...
  return (
    <div className="px-5 py-4 space-y-4">
      <div className="flex items-center justify-between mb-2">
        ...
        <button className="text-xs bg-[#4DD9AC]/10 border border-[#4DD9AC]/30 text-[#4DD9AC] px-3 py-1.5 rounded-lg hover:bg-[#4DD9AC]/20 transition-colors">
          + Create New
        </button>
      </div>
      {TEMPLATES.map((t) => {
        const preview = t.body.replace(
          /\{[a-z_]+\}/g,
          (m) => SAMPLE[m as keyof typeof SAMPLE] ?? m,
        );
        return (
          <div
            key={t.id}
            className={`bg-[#111827] border rounded-xl overflow-hidden ${editId === t.id ? "border-[#4DD9AC]/40" : "border-[#1E2530]"}`}
          >
            <div className="flex items-center justify-between px-4 py-3 border-b border-[#1E2530]">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-[#64748B]">
                    Product: {t.product} {t.default && "· Default"}
                  </div>
                </div>
              </div>
              <div className="flex gap-1.5">
                <button
                  ...
                  className={`text-[10px] px-2 py-1 rounded border transition-colors ${previewId === t.id ? "bg-[#60A5FA]/10 border-[#60A5FA]/30 text-[#60A5FA]" : "border-[#1E2530] text-[#64748B]"}`}
                >
                  👁 Preview
                </button>
                <button
                  onClick={() => setEditId(editId === t.id ? null : t.id)}
                  className={`text-[10px] px-2 py-1 rounded border transition-colors ${editId === t.id ? "bg-[#4DD9AC]/10 border-[#4DD9AC]/30 text-[#4DD9AC]" : "border-[#1E2530] text-[#64748B]"}`}
                >
                  ✏️ Edit
                </button>
                {t.default && (
                  <span className="text-[9px] px-2 py-1 bg-[#34D399]/10 border border-[#34D399]/25 text-[#34D399] rounded">
                    Default
                  </span>
                )}
              </div>
            </div>
            <div className="px-4 py-3 font-mono text-[11px] text-[#64748B] whitespace-pre-wrap leading-relaxed">
              {t.body}
            </div>
            {t.vars.length > 0 && (
              <div className="px-4 pb-3 flex gap-1.5 flex-wrap">
                {t.vars.map((v) => (
                  <span
                    key={v}
                    className="text-[9px] bg-[#0D1117] border border-[#1E2530] text-[#A78BFA] px-1.5 py-0.5 rounded font-mono"
                  >
                    {v}
                  </span>
                ))}
            ...
            {previewId === t.id && (
              <div className="mx-4 mb-3 bg-[#0D2B22] border border-[#34D399]/20 rounded-lg p-3">
                <div className="text-[9px] text-[#34D399] uppercase tracking-widest mb-1.5 font-semibold">
                  Preview with sample data
                </div>
                <div className="text-xs text-[#F1F5F9] whitespace-pre-wrap font-mono leading-relaxed">
                  {preview}
                </div>
              </div>
            )}
...
function EscalationTab() {
  const levelColor = (l: string) =>
    l === "CRITICAL" ? "#EF4444" : l === "HIGH" ? "#F97316" : "#FBBF24";

  return (
    <div className="px-5 py-4 space-y-5">
      <div className="text-sm font-bold text-[#F1F5F9] mb-2">
        📡 Escalation Matrix
      </div>
      {ESCALATION_MATRIX.map((rule) => {
        ...
        return (
          <div
            key={rule.level}
            className="bg-[#111827] border border-[#1E2530] rounded-xl overflow-hidden"
          >
            <div className="px-4 py-3 border-b border-[#1E2530] flex items-center justify-between">
              ...
              <button className="text-[10px] text-[#64748B] border border-[#1E2530] px-2 py-1 rounded flex items-center gap-1 hover:text-[#4DD9AC] hover:border-[#4DD9AC]/30 transition-colors">
                <Settings size={10} /> Edit Path
              </button>
            </div>
            <div className="px-4 py-3 space-y-2">
              {rule.steps.map((s, i) => (
                <div key={i} className="flex items-center gap-3 text-xs">
                  <div
                    className="w-6 h-6 rounded-full border-2 flex items-center justify-center font-bold shrink-0 text-[10px]"
                    style={{ borderColor: color, color }}
                  >
                    {s.step}
                  </div>
                  <div className="text-[#94A3B8] w-14 shrink-0 font-mono">
                    {s.delay}
                  </div>
                  <div className="flex-1 font-semibold text-[#F1F5F9]">
                    {s.who}
                  </div>
                  <div className="text-[10px] text-[#64748B] bg-[#0D1117] border border-[#1E2530] px-2 py-0.5 rounded">
                    {s.how}
                  </div>
                </div>
              ))}
      ...
      <div className="bg-[#111827] border border-[#1E2530] rounded-xl overflow-hidden">
        <div className="px-4 py-3 border-b border-[#1E2530] flex items-center justify-between">
          <div className="text-sm font-bold text-[#F1F5F9] flex items-center gap-1.5">
            <LayoutDashboard size={14} /> Team Members
          </div>
          <button className="text-[10px] text-[#64748B] border border-[#1E2530] px-2 py-1 rounded flex items-center gap-1 hover:text-[#4DD9AC] hover:border-[#4DD9AC]/30 transition-colors">
            <Settings size={10} /> Edit Team
          </button>
        </div>
        <table className="w-full text-xs">
          <thead className="bg-[#0D1117]">
            <tr>
              {["Role", "Name", "Contact"].map((h) => (
                <th
                  key={h}
                  className="px-4 py-2 text-left text-[#64748B] font-semibold"
                >
                  {h}
                </th>
              ))}
          ...
          <tbody className="divide-y divide-[#1E2530]">
            {TEAM.map((m) => (
              <tr key={m.name} className="hover:bg-[#0D1117] transition-colors">
                ...
                <td className="px-4 py-2.5 font-mono text-[#4DD9AC]">
                  {m.phone}
                </td>
              </tr>
            ))}
...
interface AgentMsg {
  id: string;
  role: "agent" | "driver" | "system" | "escalation";
  text: string;
  ts: string;
  typing?: boolean;
  channel?: string;
  ...
  CRITICAL: [
    {
      ...
      role: "system",
      ts: "00:00",
      text: "🔴 LangGraph Agent activated — CRITICAL breach on {code}. Initiating autonomous protocol.",
    },
    {
      id: "a2",
      role: "agent",
      ts: "00:02",
      text: "🌡️ URGENT: {code} cargo at 9.8°C — 3.8° above safe max. Compressor running at 98% load. STOP and check reefer now.",
      channel: "WhatsApp",
    },
    {
      id: "a3",
      role: "system",
      ts: "02:00",
      text: "⚠️ No driver response after 2 min. Agent escalating automatically…",
    },
    {
      id: "a4",
      role: "escalation",
      ts: "02:05",
      text: "🚨 Auto-escalating to Fleet Manager Sunil Mehta via WhatsApp + Call",
    },
    {
      id: "a5",
      role: "agent",
      ts: "02:06",
      text: "URGENT — Driver unresponsive on {code}. Reefer failure risk. Please call immediately.",
      channel: "WhatsApp to Sunil Mehta",
    },
    {
      id: "a6",
      role: "driver",
      ts: "04:10",
      text: "On it. Called driver. He's pulling over at NH-37.",
    },
    {
      id: "a7",
      role: "system",
      ts: "04:15",
      text: "✅ Agent logged intervention. Nearest cold hub pinged. Estimated save: ₹1.8L cargo value.",
    },
  ],
  HIGH: [
    {
      ...
      role: "system",
      ts: "00:00",
      text: "🟡 LangGraph Agent monitoring — HIGH humidity on {code}. Composing advisory.",
    },
    {
      id: "b2",
      role: "agent",
      ts: "00:05",
      text: "💧 Humidity at 84% — safe limit 75%. Seafood packaging at risk. Please reseal any open containers immediately. SOP-HUM-02.",
      channel: "WhatsApp",
    },
    { id: "b3", role: "driver", ts: "02:10", text: "Checking packaging now…" },
    {
      ...
      role: "driver",
      ts: "07:00",
      text: "Resealed boxes. Humidity dropping, now at 81%.",
    },
    {
      id: "b5",
      role: "system",
      ts: "07:05",
      text: "✅ Agent logging driver ACK. Monitoring for next 15 min. Risk downgraded to MEDIUM.",
    },
  ],
  MEDIUM: [
    {
      ...
      role: "system",
      ts: "00:00",
      text: "ℹ️ LangGraph Agent monitoring — GPS signal lost for {code}. Waiting for auto-restore.",
    },
    {
      id: "c2",
      role: "agent",
      ts: "00:30",
      text: "📡 Your GPS appears offline. No action needed if in tunnel zone. Please confirm location when signal returns.",
      channel: "SMS",
    },
    {
      id: "c3",
      role: "system",
      ts: "12:00",
      text: "✅ GPS restored automatically. No action required. Agent closing case.",
    },
  ],
};
...
function AgentLiveFeed({ alert }: { alert: EnrichedAlert }) {
  ...
  const roleStyle = (role: string) => {
    if (role === "agent")
      return {
        bg: "bg-[#0D2B1E] border-[#4DD9AC]/30",
        text: "text-[#F1F5F9]",
        align: "items-end",
        bubble: "rounded-tr-sm",
      };
    if (role === "driver")
      return {
        bg: "bg-[#111827] border-[#1E2530]",
        text: "text-[#CBD5E1]",
        align: "items-start",
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-xs font-bold text-[#F1F5F9] flex items-center gap-1.5">
              LangGraph Agent
              {running && (
                <span className="text-[10px] text-[#4DD9AC] animate-pulse">
                  ● ACTIVE
                </span>
              )}
              {done && (
                <span className="text-[10px] text-[#34D399]">✓ COMPLETE</span>
              )}
            </div>
            <div className="text-[10px] text-[#64748B]">
              Autonomous intervention · {alert.shipCode}
            </div>
          </div>
        </div>
        <motion.button
          ...
          className={`flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg font-bold transition-all ${
            running
              ? "bg-[#4DD9AC]/10 text-[#4DD9AC] cursor-wait"
      ...
      >
        {visible.length === 0 && !running && (
          <div className="flex flex-col items-center justify-center h-32 gap-3 opacity-50">
            ...
            <p className="text-xs text-[#64748B] text-center">
              Click <strong>Run Agent</strong> to simulate the LangGraph
              autonomous intervention for this alert
            </p>
          </div>
        )}
        <AnimatePresence>
          {visible.map((msg) => {
            ...
            if (msg.role === "system" || msg.role === "escalation")
              return (
                <motion.div
                  key={msg.id}
                ...
                >
                  <span
                    className={`text-[10px] px-3 py-1.5 rounded-lg border max-w-[90%] text-center leading-relaxed ${s.bg} ${s.text} border-${msg.role === "escalation" ? "[#A78BFA]/25" : "[#1E2530]"}`}
                  >
                    <span className="font-mono text-[9px] mr-2 opacity-60">
                      {msg.ts}
                    </span>
                    {msg.text}
                  </span>
            ...
            return (
              ...
              >
                ...
                {isAgent && msg.channel && (
                  <span className="text-[9px] text-[#4DD9AC]/70 px-1 flex items-center gap-1">
                    <Bot size={9} /> via {msg.channel}
                  </span>
                )}
                <div
                  className={`max-w-[85%] px-3 py-2.5 rounded-xl text-xs leading-relaxed border ${s.bg} ${s.text} ${s.bubble}`}
                >
                  {fillCode(msg.text)}
                </div>
                <div
                  className={`text-[9px] text-[#4A5568] px-1 flex items-center gap-1 ${isAgent ? "flex-row-reverse" : ""}`}
                >
                  <span>{msg.ts}</span>
                  {isAgent && (
        ...
        {typing && (
          ...
          >
            ...
            <span className="text-[10px] text-[#4DD9AC] mb-1">
              Agent composing…
            </span>
          </motion.div>
        )}
  ...
  return [
    ...
    },
    {
      ...
      branch: {
        ...
        yes: "Immediate escalation chain",
        no: "Standard WhatsApp SOP",
      },
      agentNote:
        "LangGraph router selected based on product_type + risk_category",
    },
    {
      id: "p4",
    ...
    },
    {
      ...
      detail: alert.acknowledged
        ? "Driver acknowledged in 2m 10s ✓"
        : alert.escalated
          ? "Timeout — no ACK after 10 min"
          : "Watching for driver ACK (timeout: 10 min)…",
    ...
    },
    {
      ...
      detail: alert.escalated
        ? "Escalated to Fleet Manager Sunil Mehta via WhatsApp + Call"
        : alert.acknowledged
          ? "Skipped — driver responded in time"
          : "Pending escalation to Fleet Manager",
      agentNote:
        "Escalation matrix: CRITICAL → Fleet Manager (10 min) → Ops Lead (15 min)",
    },
    {
      id: "p7",
      label: "Resolution & Audit Log",
      status: alert.resolved ? "done" : "pending",
      detail: alert.resolved
        ? "Case closed. Resolution logged to Supabase + Blockchain audit trail."
        : "Awaiting resolution…",
      agentNote:
        "Immutable audit trail written to PostgreSQL + Sepolia testnet via oracle",
    },
  ];
}
    ...
    <div className="px-4 py-4 space-y-2">
      <div className="flex items-center gap-2 mb-4">
        ...
        <span className="text-xs font-bold text-[#F1F5F9]">
          Autonomous Resolution Playbook
        </span>
      ...
      {steps.map((step, i) => {
        ...
        return (
          <div key={step.id} className="relative">
            ...
            {i < steps.length - 1 && (
              <div
                className="absolute left-[19px] top-[36px] w-px h-[calc(100%+8px)] z-0"
                style={{
                  background: step.status === "done" ? "#34D399" : "#1E2530",
                }}
              />
            )}
            <motion.button
            ...
            >
              <div className="flex items-center gap-3">
                {/* Step circle */}
                <div
                  className="w-9 h-9 rounded-full border-2 shrink-0 flex items-center justify-center text-[11px] font-bold transition-all"
                  style={{
                    borderColor: col,
                    color: col,
                    background: `${col}12`,
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-xs font-semibold" style={{ color: txt }}>
                    {step.label}
                  </div>
                ...
                <div className="shrink-0 flex items-center gap-1">
                  ...
                  <ChevronRight
                    size={12}
                    className="text-[#4A5568] transition-transform"
                    style={{ transform: isExp ? "rotate(90deg)" : "" }}
                  />
                </div>
              </div>
            </motion.button>
                  ...
                  <div className="bg-[#111827] border border-[#1E2530] rounded-lg p-3 space-y-2">
                    ...
                    {step.agentNote && (
                      <div className="flex items-start gap-1.5 bg-[#0A0D14] border border-[#1E2530] rounded-md p-2">
                        <Bot
                          size={10}
                          className="text-[#4DD9AC] mt-0.5 shrink-0"
                        />
                        <span className="text-[10px] text-[#4DD9AC] leading-relaxed">
                          {step.agentNote}
                        </span>
                      </div>
                    )}
...
export function AlertsCenter() {
  ...
  const [liveFilter, setLiveFilter] = useState<
    "all" | "unresolved" | "pending" | "resolved" | "escalated"
  >("all");
  ...
  const [toasts, setToasts] = useState<
    Array<{ id: string; msg: string; type: "ok" | "warn" | "crit" }>
  >([]);
  ...
  const { data: rtAlertsLive } =
    useRealtimeData<Record<string, any>>("/alerts_live");
  ...
  useEffect(() => {
    Promise.all([getAlerts(), getShipments("all")])
      .then(([apiAlerts, ships]) => {
        setShipments(ships);
        const enriched: EnrichedAlert[] = apiAlerts.map((a, i) => {
          const t = ALERT_TYPES[i % ALERT_TYPES.length];
          const ship = ships.find(
            (s) =>
              s.id === a.shipment_id || s.shipment_code === a.shipment_code,
          );
          return {
            ...a,
            severity: t.sev,
            ...
            escalateCountdown:
              t.sev === "CRITICAL" ? 262 : t.sev === "HIGH" ? 620 : 0,
            thread: [
              {
                time: fmtTime(a.created_at),
                who: "outbound" as const,
                text: a.message_body ?? "Alert sent",
                read: !!a.delivered,
              },
            ],
          } as EnrichedAlert;
        });
        // Use real API alerts; fall back to template alerts for demo/dev if none returned
        const finalAlerts =
          enriched.length > 0
            ? enriched
            : (TEMPLATE_ALERTS as unknown as EnrichedAlert[]);
        setAlerts(finalAlerts);
        if (!selected && finalAlerts.length > 0) setSelected(finalAlerts[0]);
      })
      .catch(() => {
        // API unreachable: show template alerts so the page is never blank
        const fallback = TEMPLATE_ALERTS as unknown as EnrichedAlert[];
        setAlerts(fallback);
    ...
    setAlerts((prev) => {
      ...
      const newLive: EnrichedAlert[] = Object.entries(rtAlertsLive)
        ...
        .map(([id, raw]: [string, any]) => {
          const t =
            ALERT_TYPES.find(
              (at) => at.key === (raw.type || "").toLowerCase(),
            ) ?? ALERT_TYPES[0];
          const sev = (raw.severity ?? "HIGH") as
            | "CRITICAL"
            | "HIGH"
            | "MEDIUM"
            | "LOW";
          return {
            ...
            shipment_code: raw.shipment_id,
            severity: sev,
            alertType: t.label,
            typeIcon: t.icon,
            resolved:
              raw.ack_status === "FALSE_POSITIVE" ||
              raw.ack_status === "RESOLVED",
            acknowledged:
              raw.ack_status === "READ" || raw.ack_status === "ACKED",
            ...
            shipCode: raw.shipment_id ?? "N/A",
            route: "—",
            productIcon: "📦",
            escalateCountdown:
              sev === "CRITICAL" ? 262 : sev === "HIGH" ? 620 : 0,
            thread: [
              {
                time: fmtTime(
                  new Date(raw.sent_at ?? Date.now()).toISOString(),
                ),
                who: "outbound" as const,
                text: raw.message ?? "",
                read: raw.ack_status === "READ",
              },
            ],
            message_body: raw.message,
            delivered: raw.ack_status !== "FAILED",
      ...
      newLive.forEach((a) => {
        if (a.severity === "CRITICAL")
          toast(`🚨 CRITICAL alert on ${a.shipCode}!`, "crit");
        else if (a.severity === "HIGH")
          toast(`⚠️ HIGH alert on ${a.shipCode}`, "warn");
      });
      return updated;
    });
  }, [rtAlertsLive]);
    ...
    Object.entries(rtNetworkEvents).forEach(([eventId, raw]: [string, any]) => {
      ...
      if (
        ...
        const sev: EnrichedAlert["severity"] =
          evType === "SPOILAGE_ALERT" || evType === "TEMP_BREACH"
            ? "CRITICAL"
            : evType === "RISK_ESCALATED"
              ? "HIGH"
              : "MEDIUM";
        const typeInfo =
          ALERT_TYPES.find((t) => t.sev === sev) || ALERT_TYPES[0];
        const newAlert: EnrichedAlert = {
          ...
          escalateCountdown:
            sev === "CRITICAL" ? 300 : sev === "HIGH" ? 600 : 0,
          thread: [
            {
              time: fmtTime(raw.timestamp),
              who: "outbound" as const,
              text: raw.message || evType,
              read: false,
            },
          ],
        } as EnrichedAlert;
    ...
    setAlerts((prev) =>
      prev.map((a) => {
        ...
        const newSev: EnrichedAlert["severity"] =
          rt.risk_category === "CRITICAL"
            ? "CRITICAL"
            : rt.risk_category === "HIGH"
              ? "HIGH"
              : rt.risk_category === "MEDIUM"
                ? "MEDIUM"
                : "LOW";
      ...
      setAlerts((prev) =>
        prev.map((a) => {
          if (a.escalateCountdown > 0 && !a.resolved) {
            ...
            if (next === 0 && !a.escalated)
              toast(`🚨 Auto-escalating ${a.shipCode}!`, "crit");
            return {
              ...a,
              escalateCountdown: next,
              escalated: next === 0 ? true : a.escalated,
            };
          }
          return a;
        }),
  ...
  const handleAction = (act: string, id: string) => {
    ...
    if (act === "escalate") {
      setAlerts((prev) =>
        prev.map((a) => (a.id === id ? { ...a, escalated: true } : a)),
      );
  ...
  const liveAlerts = alerts
    ...
    .filter(
      (a) =>
        !search ||
        a.shipCode.toLowerCase().includes(search.toLowerCase()) ||
  ...
  const sortedLive = [...liveAlerts].sort(
  ...
  const pendingAckCount = alerts.filter(
  ...
  const histFiltered = [...alerts]
    .filter(
      (a) =>
        !histSearch ||
        a.shipCode.toLowerCase().includes(histSearch.toLowerCase()) ||
        a.alertType.toLowerCase().includes(histSearch.toLowerCase()),
    )
    .sort((a, b) =>
      sortDir === "desc"
  ...
  return (
    ...
    >
      ...
      {toasts
        .filter((t) => t.type === "crit")
        .map((t) => (
          <div
            key={t.id}
            className="w-full bg-[#EF4444] text-white text-sm font-bold px-5 py-3 flex items-center gap-3 shrink-0 z-50"
        ...
        <div className="flex items-center gap-3 text-xs">
          ...
          {pendingAckCount > 0 && (
            <span className="text-[#FBBF24] font-bold flex items-center gap-1.5">
              <AlertTriangle size={12} /> {pendingAckCount} Pending Ack
            </span>
          )}
          <span className="text-[#34D399] flex items-center gap-1.5">
            <CheckCircle size={12} /> {resolvedToday} Resolved Today
          </span>
        </div>
        <div className="flex-1" />
        <button
          onClick={() => navigate("/dashboard")}
          className="text-[10px] border border-[#1E2530] text-[#64748B] hover:text-white px-3 py-1.5 rounded flex items-center gap-1 transition-colors"
        >
      ...
      <div className="shrink-0 bg-[#0D1117] border-b border-[#1E2530] px-5 flex items-center gap-1">
        {[
          ...
          [
            "escalation",
            <div className="flex items-center gap-1.5">
              <LayoutDashboard size={12} /> Escalation Matrix
            </div>,
          ],
        ].map(([k, l]: any) => (
          <button
          ...
          <div className="flex-1 min-w-0 bg-[#080B12] overflow-hidden">
            {selected ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-center px-8">
                ...
                <div className="text-lg font-semibold text-[#CBD5E1] mb-2">
                  Select an alert
                </div>
                <div className="text-sm text-[#64748B]">
                  Click any card to see communication thread, trigger details,
                  and action buttons.
                </div>
              </div>
            )}
                ...
                <thead className="bg-[#0D1117]">
                  <tr>
                    {[
                      ...
                      <th
                        key={h}
                        className="px-4 py-3 text-left text-[#64748B] font-semibold"
                      >
                        {h}
                      </th>
                    ))}
                ...
                <tbody className="divide-y divide-[#1E2530]">
                  {histFiltered.map((a, i) => {
                    ...
                    return (
                      <tr
                        key={a.id}
                        className={`${i % 2 === 0 ? "bg-[#111827]" : "bg-[#0D1117]"} hover:bg-[#1A2235] cursor-pointer transition-colors`}
                        onClick={() => {
                          setSelected(a);
                          setMainTab("live");
                        }}
                      >
                        ...
                        <td className="px-4 py-3 font-mono font-bold text-[#4DD9AC]">
                          {a.shipCode}
                        </td>
                        <td className="px-4 py-3">
                          <span style={{ color }}>
                            {a.typeIcon} {a.alertType}
                          </span>
                        </td>
                        <td className="px-4 py-3 text-[#94A3B8]">
                          {a.driver.split(" ").slice(0, 2).join(" ")}
                        </td>
                        ...
                        <td className="px-4 py-3">
                          {a.acknowledged ? (
                            <span className="text-[#34D399]">✅ Read</span>
                          ) : (
                            <span className="text-[#EF4444]">🔴 Unread</span>
                          )}
                        </td>
                        <td className="px-4 py-3">
                          {a.resolved ? (
                            <span className="text-[#34D399]">✅ Resolved</span>
                          ) : a.escalated ? (
                            <span className="text-[#A78BFA]">🚨 Escalated</span>
                          ) : a.acknowledged ? (
