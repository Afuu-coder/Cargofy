...
<a className="text-slate-400 font-medium hover:text-slate-200 hover:bg-slate-800/50 transition-colors px-3 py-1.5 rounded-DEFAULT text-sm flex items-center gap-2" href="#">Comms</a>
</nav>
</div>
...
<h2 className="font-headline font-bold text-sm text-on-surface tracking-normal capitalize">Control Tower</h2>
<p className="text-slate-500 text-[10px] tracking-normal capitalize mt-1">Live Ops</p>
</div>
<nav className="flex-1 py-4 flex flex-col gap-1 px-3">
<a className="bg-[#4DD9AC]/10 text-[#4DD9AC] border-r-2 border-[#4DD9AC] Active: scale-[0.98] duration-200 flex items-center gap-3 px-3 py-2.5 rounded-l-DEFAULT" href="#">
<span className="material-symbols-outlined text-[18px]">precision_manufacturing</span>
                    Operations
                </a>
<a className="text-slate-500 font-semibold hover:bg-slate-800/40 hover:text-slate-200 transition-all flex items-center gap-3 px-3 py-2.5 rounded-DEFAULT" href="#">
...
<a className="text-slate-500 font-semibold hover:bg-slate-800/40 hover:text-slate-200 transition-all flex items-center gap-3 px-3 py-2 rounded-DEFAULT" href="#">
...
<div>
<h1 className="font-headline text-2xl font-bold text-on-surface">Review &amp; Dispatch</h1>
...
<span className="font-headline font-semibold text-on-surface">Dairy - Milk</span>
<span className="font-mono text-sm text-on-surface-variant">420 Litres</span>
</div>
<div className="flex gap-2 mt-2">
<span className="bg-tertiary-container/10 text-tertiary-container text-[10px] font-label px-2 py-0.5 rounded-DEFAULT uppercase tracking-wider">High Priority</span>
<span className="bg-primary/10 text-primary text-[10px] font-label px-2 py-0.5 rounded-DEFAULT uppercase tracking-wider">Fresh</span>
</div>
</div>
</div>
</div>
...
<span className="font-headline font-semibold text-on-surface">Guwahati</span>
<span className="font-mono text-xs text-on-surface-variant mt-0.5">Pickup: 14 Oct 07:00</span>
</div>
<div className="flex-1 flex flex-col items-center justify-center px-4">
<span className="font-mono text-[10px] text-on-surface-variant mb-1">214 km</span>
...
<span className="font-headline font-semibold text-on-surface">Shillong</span>
<span className="font-mono text-xs text-secondary mt-0.5">SLA: 12:00</span>
</div>
</div>
</div>
</div>
...
<div className="flex flex-col">
<span className="font-label text-[10px] uppercase tracking-wider text-on-surface-variant">Assigned Vehicle &amp; Driver</span>
<span className="font-body text-sm font-medium text-on-surface mt-0.5">MH-12-AB-3391 <span className="text-outline-variant mx-1">•</span> Ramesh Kumar</span>
</div>
</div>
<div className="bg-surface-container rounded-DEFAULT p-3 flex items-center gap-3">
<div className="h-8 w-8 rounded-full bg-surface-container-highest flex items-center justify-center">
<span className="material-symbols-outlined text-[16px] text-on-surface-variant">sensors</span>
</div>
<div className="flex flex-col">
<span className="font-label text-[10px] uppercase tracking-wider text-on-surface-variant">Monitoring Active</span>
<span className="font-body text-sm font-medium text-on-surface mt-0.5">IoT-4821 <span className="text-outline-variant mx-1">•</span> WhatsApp Alerts</span>
</div>
</div>
</div>
</div>
...
<span className="font-label text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">Route Health</span>
<span className="font-headline text-lg font-semibold text-tertiary">Medium</span>
<span className="font-body text-xs text-on-surface-variant mt-2 border-t border-outline-variant/20 pt-2">Traffic delays expected near bypass.</span>
</div>
...
<span className="font-label text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">Spoilage Sens.</span>
<span className="font-headline text-lg font-semibold text-error">High</span>
<span className="font-body text-xs text-on-surface-variant mt-2 border-t border-outline-variant/20 pt-2">Requires continuous 2-4°C temp.</span>
</div>
<div className="bg-surface-container-low rounded-DEFAULT p-4 flex flex-col border border-outline-variant/15">
<span className="font-label text-[10px] uppercase tracking-widest text-on-surface-variant mb-2">Excursion Risk</span>
<div className="flex items-end gap-2">
<span className="font-mono text-2xl text-on-surface leading-none">18%</span>
<span className="material-symbols-outlined text-[16px] text-primary mb-1">trending_down</span>
</div>
