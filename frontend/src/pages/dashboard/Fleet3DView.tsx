...
import {
  CargoMap3D,
  type CargoMap3DHandle,
} from "../../components/maps/CargoMap3D";
...
export function Fleet3DView() {
  ...
  const [toasts, setToasts] = useState<
    Array<{ id: string; msg: string; color: string }>
  >([]);
  ...
  const triggerCrisis = async (scenario: string) => {
    ...
    try {
      ...
      const facility =
        data.agent_result?.nearest_facility?.name || "nearest cold hub";
      addToast(`🚚 CARGOFY AI: Rerouting to ${facility}`, "#EF4444");
    } catch {
      addToast(
        "🤖 AI Agent triggered (demo mode — backend offline)",
        "#F59E0B",
      );
    } finally {
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                padding: "4px 8px",
                fontSize: 11,
                cursor: crisisRunning ? "not-allowed" : "pointer",
                fontWeight: 700,
      ...
      <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
        ...
        <div style={{ flex: 1, position: "relative", display: "flex" }}>
          ...
          >
            ...
            {(trucks.length > 0
              ...
              const col =
                t.risk_category === "CRITICAL"
                  ? "#EF4444"
                  : t.risk_category === "HIGH"
                    ? "#F97316"
                    : t.risk_category === "MEDIUM"
                      ? "#FBBF24"
                      : "#34D399";
                ...
                >
                  <div
                    style={{
                      ...
                      fontSize: 10,
                      fontWeight: 700,
                      color: isSel ? col : "#F1F5F9",
                    }}
                  >
                    {t.shipment_code}
                  </div>
                  <div style={{ fontSize: 9, color: "#64748B" }}>
                    {t.product_type?.toUpperCase()}
                  </div>
                  ...
                  {isSel && (
                    <div
                      style={{ fontSize: 8, color: "#4DD9AC", marginTop: 2 }}
                    >
                      🎬 TRACKING — GOD MODE
                    </div>
                  )}
        ...
        >
          ...
          <div style={{ flex: 1, overflow: "auto", padding: 8 }}>
            {agentLog.length === 0 ? (
              ...
              >
                ...
                No agent events yet.
                <br />
                Trigger a crisis scenario to see the AI agent respond in
                real-time.
              </div>
            ) : (
          ...
          >
            ...
            <div>
              Each trip auto-mints an immutable certificate on Ethereum Sepolia.
            </div>
