...
export const RISK_COLORS: Record<RiskCategory, {
  ...
  CRITICAL: { bg: '#FEE2E2', text: '#7F1D1D', border: '#EF4444', hex: '#ef4444' },
};
...
export const PRODUCT_EMOJI: Record<string, string> = {
  milk: '🥛', fish: '🐟', frozen: '❄️', produce: '🥦',
  pharma: '💊', fruits: '🍎', vegetables: '🥕', other: '📦',
};
